...
(function () {
			...
			return {
				...
				on: function (b, c, k, h, p) {
					...
					if (0 > y.getListenerIndex(c)) {
						...
						m.fn = c;
						m.priority = p;
						for (var A = y.length - 1; 0 <= A; A--)
							if (y[A].priority <= p) return y.splice(A + 1, 0, m), {
								removeListener: g
							};
						y.unshift(m)
					}
						...
						if (x) {
							...
							if (A.length)
								for (var A = A.slice(0),
									F, v = 0; v < A.length; v++) {
									if (x.errorProof) try {
										F = A[v].call(this, g, m, e, h)
									} catch (l) { } else F = A[v].call(this, g, m, e, h);
									F === a ? d = 1 : "undefined" != typeof F && (m = F);
									if (c || d) break
								}
						}
						m = d ? !1 : "undefined" == typeof m ? !0 : m;
						c = p;
						d = y;
						return m
					}
	...
	(function () {
		...
		var b = [],
			...
			g = function (a, y) {
				return "#" == y[0] ? String.fromCharCode(parseInt(y.slice(1), 10)) : m[y]
			};
		...
		CKEDITOR.tools = {
			...
			extend: function (a) {
				var b = arguments.length,
					c, g;
				"boolean" == typeof (c = arguments[b - 1]) ? b-- : "boolean" == typeof (c = arguments[b - 2]) && (g = arguments[b - 1], b -= 2);
				for (var h = 1; h < b; h++) {
					var l = arguments[h] || {};
					CKEDITOR.tools.array.forEach(CKEDITOR.tools.object.keys(l), function (b) {
						if (!0 === c || null == a[b])
							if (!g || b in g) a[b] = l[b]
					})
				}
			...
			transformPlainTextToHtml: function (a, b) {
				...
				return g = g.replace(/(>|\s) /g, function (a, b) {
					return b + "\x26nbsp;"
				}).replace(/ (?=<)/g, "\x26nbsp;")
			},
			...
			normalizeCssText: function (a, b) {
				var c = [],
					g, h = CKEDITOR.tools.parseCssText(a, !0, b);
			...
			parseCssText: function (a, b, c) {
				var g = {};
				c && (a = (new CKEDITOR.dom.element("span")).setAttribute("style",
				...
				a.replace(/&quot;/g, '"').replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function (a, c, x) {
					b && (c = c.toLowerCase(), "font-family" == c && (x = x.replace(/\s*,\s*/g, ",")), x = CKEDITOR.tools.trim(x));
					g[c] = x
				});
				return g
			},
			...
			enableHtml5Elements: function (a, b) {
				for (var c = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time video".split(" "), g = c.length, h; g--;) h = a.createElement(c[g]), b && a.appendChild(h)
			},
			...
			keystrokeToArray: function (a, b) {
				var c = b & 16711680,
					...
					l = [],
					e = [];
				c & CKEDITOR.CTRL && (l.push(h ? "⌘" : a[17]), e.push(h ? a[224] : a[17]));
				c & CKEDITOR.ALT && (l.push(h ? "⌥" : a[18]), e.push(a[18]));
				c & CKEDITOR.SHIFT &&
					(l.push(h ? "⇧" : a[16]), e.push(a[16]));
				g && (a[g] ? (l.push(a[g]), e.push(a[g])) : (l.push(String.fromCharCode(g)), e.push(String.fromCharCode(g))));
				return {
					display: l,
					aria: e
				}
			...
			escapeCss: function (a) {
				if (a)
					if (window.CSS && CSS.escape) a = CSS.escape(a);
						...
						a = String(a);
						for (var b = a.length, c = -1, g, h = "", l = a.charCodeAt(0); ++c < b;) g = a.charCodeAt(c), h = 0 == g ? h + "�" : 127 == g || 1 <= g && 31 >= g || 0 == c && 48 <= g && 57 >= g || 1 == c && 48 <= g && 57 >= g && 45 == l ? h + ("\\" + g.toString(16) + " ") : 0 == c && 1 == b && 45 == g ? h + ("\\" + a.charAt(c)) : 128 <= g || 45 == g || 95 == g || 48 <= g && 57 >= g || 65 <= g && 90 >= g || 97 <= g && 122 >= g ? h + a.charAt(c) : h + ("\\" + a.charAt(c));
						a = h
					}
				else a = "";
				return a
			...
			convertHexStringToBytes: function (a) {
				var b = [],
					c = a.length / 2,
					g;
				for (g = 0; g < c; g++) b.push(parseInt(a.substr(2 *
					g, 2), 16));
				return b
			},
			...
			array: {
				filter: function (a, b, c) {
					var g = [];
					this.forEach(a, function (h, l) {
						b.call(c, h, l, a) && g.push(h)
					});
					return g
				},
				find: function (a, b, c) {
				...
				map: function (a, b, c) {
					for (var g = [], h = 0; h < a.length; h++) g.push(b.call(c, a[h], h, a));
					return g
				},
				reduce: function (a,
					b, c, g) {
			...
			object: {
				...
				merge: function (a, b) {
					...
					c.array.forEach(c.object.keys(h), function (a) {
						g[a] = "object" === typeof h[a] && "object" === typeof g[a] ? c.object.merge(g[a], h[a]) : h[a]
					});
					return g
				}
			},
		...
		CKEDITOR.tools.style.border = CKEDITOR.tools.createClass({
			...
			statics: {
				...
				splitCssValues: function (a, b) {
					b = b || {};
					var c = CKEDITOR.tools.array.reduce(["width", "style", "color"], function (c, g) {
						var h = a["border-" + g] || b[g];
						c[g] = h ? CKEDITOR.tools.style.parse.sideShorthand(h) : null;
						return c
					}, {});
					return CKEDITOR.tools.array.reduce(["top", "right", "bottom", "left"], function (b, g) {
						var h = {},
							e;
						for (e in c) {
							var d =
	...
	CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
		...
		appendStyleText: function (a) {
			if (this.$.createStyleSheet) {
				...
				b.append(new CKEDITOR.dom.text(a,
					this));
		...
		CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
			...
			mergeSiblings: function () {
				function a(b, c, g) {
					if (c && c.type == CKEDITOR.NODE_ELEMENT) {
						...
						if (b.isIdentical(c)) {
							for (var e = g ? b.getLast() : b.getFirst(); d.length;) d.shift().move(b, !g);
							c.moveChildren(b, !g);
							c.remove();
			...
			removeStyle: function (a) {
				...
				if (b.removeProperty || "border" != a && "margin" != a && "padding" != a) b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText || this.removeAttribute("style");
					...
					for (var b = [], d = 0; d < c.length; d++)
						if (g)
							for (var e =
								0; e < g.length; e++) b.push([a, c[d], g[e]].join("-"));
			...
			getDocumentPosition: function (a) {
				...
				if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
					...
					var f = this.$.getBoundingClientRect(),
						k = g.$.documentElement,
						v = k.clientTop || d.$.clientTop || 0,
						l = k.clientLeft || d.$.clientLeft || 0,
						L = !0;
					CKEDITOR.env.ie && (L = g.getDocumentElement().contains(this), g = g.getBody().contains(this), L = e && g || !e && L);
					L && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || k.scrollLeft, c = d.$.scrollTop || k.scrollTop) : (c = e ? d.$ : k, b = c.scrollLeft, c = c.scrollTop), b = f.left + b - l, c = f.top + c - v)
				} else
					for (v = this, l = null; v && "body" != v.getName() &&
						"html" != v.getName();) {
						b += v.$.offsetLeft - v.$.scrollLeft;
						c += v.$.offsetTop - v.$.scrollTop;
						v.equals(this) || (b += v.$.clientLeft || 0, c += v.$.clientTop || 0);
						for (; l && !l.equals(v);) b -= l.$.scrollLeft, c -= l.$.scrollTop, l = l.getParent();
						l = v;
			...
			scrollIntoParent: function (a, b, c) {
				...
				function v(a, b) {
					...
					g = a.getWindow();
					g.equals(b) || (g = v(CKEDITOR.dom.element.get(g.$.frameElement), b), c.x += g.x, c.y += g.y);
					return c
				}
				...
				var w = v(a, e),
					J = this.$.offsetHeight;
				g = this.$.offsetWidth;
				var G = a.$.clientHeight,
					q = a.$.clientWidth;
				e = d.x - l(this, "left") - w.x || 0;
				f = d.y - l(this, "top") - w.y || 0;
				g = d.x + g + l(this, "right") - (w.x + q) || 0;
				d = d.y + J + l(this, "bottom") - (w.y + G) || 0;
			...
			copyAttributes: function (a, b) {
				...
				for (var g = 0; g < c.length; g++) {
					var d = c[g],
						...
						f;
					if (!(e in b))
						if ("checked" == e && (f = this.getAttribute(e))) a.setAttribute(e, f);
						else if (!CKEDITOR.env.ie || this.hasAttribute(e)) f = this.getAttribute(e), null === f && (f = d.nodeValue), a.setAttribute(e, f)
				}
				"" !== this.$.style.cssText &&
	...
	(function () {
		function a(a, b) {
			...
			if (!a && !this._.guardLTR) {
				var p = g.type == CKEDITOR.NODE_ELEMENT ? g : g.getParent(),
					E = g.type == CKEDITOR.NODE_ELEMENT ? g.getChild(f) : g.getNext();
			...
			if (a && !this._.guardRTL) {
				var C = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(),
					t = d.type == CKEDITOR.NODE_ELEMENT ? e ? d.getChild(e - 1) : null : d.getPrevious();
				this._.guardRTL = function (a, b) {
					return (!b || !C.equals(a)) && (!t || !a.equals(t)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
				}
			}
			var B = a ? this._.guardRTL : this._.guardLTR;
			x = h ? function (a, b) {
				return !1 === B(a, b) ? !1 : h(a, b)
			} : B;
			this.current ? g = this.current[m](!1, k, x) : (a ? g.type == CKEDITOR.NODE_ELEMENT &&
				(g = 0 < f ? g.getChild(f - 1) : !1 === x(g, !0) ? null : g.getPreviousSourceNode(!0, k, x)) : (g = d, g.type == CKEDITOR.NODE_ELEMENT && ((g = g.getChild(e)) || (g = !1 === x(d, !0) ? null : d.getNextSourceNode(!0, k, x)))), g && !1 === x(g) && (g = null));
			for (; g && !this._.end;) {
				this.current = g;
		...
		CKEDITOR.dom.walker.bogus = function (a) {
			...
			return function (c) {
				...
				g && (g = c.getParent(), c = c.getNext(b), g = g.isBlockBoundary() &&
		...
		var f = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/,
			...
			p = function (a) {
				return k(a) || e(a) || a.type == CKEDITOR.NODE_ELEMENT && a.is(CKEDITOR.dtd.$inline) && !a.is(CKEDITOR.dtd.$empty)
			};
		...
		CKEDITOR.dom.walker.editable = function (a) {
			return function (b) {
				b =
					m(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(x) && g(b)) ? !0 : !1;
				return !!(a ^ b)
			}
		};
	...
	(function () {
		...
		function d(a, b, c, d, e) {
			function f(a, b, c, g) {
				var R = c ? a.getPrevious() : a.getNext();
				if (g && k) return R;
				p || g ? b.append(a.clone(!0, e), c) : (a.remove(), m && b.append(a, c));
				return R
			}

			function l() {
				var a, b, c, g = Math.min(O.length, r.length);
				for (a = 0; a < g; a++)
					if (b = O[a], c = r[a], !b.equals(c)) return a;
				return a - 1
			}
			...
			var q = a.startContainer,
				...
				E = a.endOffset,
				C, t, B, z, H, N;
			if (p && u.type == CKEDITOR.NODE_TEXT && (q.equals(u) || q.type === CKEDITOR.NODE_ELEMENT && q.getFirst().equals(u))) c.append(a.document.createText(u.substring(K, E)));
			else {
				u.type == CKEDITOR.NODE_TEXT ? p ? N = !0 : u = u.split(E) : 0 < u.getChildCount() ? E >= u.getChildCount() ? (u = u.getChild(E - 1), t = !0) : u = u.getChild(E) : z = t = !0;
				q.type == CKEDITOR.NODE_TEXT ? p ? H = !0 : q.split(K) : 0 < q.getChildCount() ? 0 === K ? (q = q.getChild(K), C = !0) : q = q.getChild(K - 1) : B = C = !0;
				for (var O = q.getParents(), r = u.getParents(), I = l(),
					M = O.length - 1, n = r.length - 1, D = c, R, aa, X, ea = -1, V = I; V <= M; V++) {
					aa = O[V];
					X = aa.getNext();
					for (V != M || aa.equals(r[V]) && M < n ? b && (R = D.append(aa.clone(0, e))) : C ? f(aa, D, !1, B) : H && D.append(a.document.createText(aa.substring(K))); X;) {
						if (X.equals(r[V])) {
							ea = V;
							break
						}
				...
				D = c;
				for (V = I; V <= n; V++)
					if (c = r[V], X = c.getPrevious(), c.equals(O[V])) b && (D = D.getChild(0));
					else {
						V != n || c.equals(O[V]) && n < M ? b && (R = D.append(c.clone(0, e))) : t ? f(c, D, !1, z) : N && D.append(a.document.createText(c.substring(0, E)));
						if (V > ea)
							for (; X;) X = f(X, D, !0);
						D = R
					} p ||
		...
		function b() {
			...
			return function (f) {
				return c(f) || b(f) ? !0 : d(f) && !a ? a = !0 : f.type == CKEDITOR.NODE_TEXT && (f.hasAscendant("pre") || CKEDITOR.tools.trim(f.getText()).length) || f.type == CKEDITOR.NODE_ELEMENT && !f.is(e) ? !1 : !0
			}
		}
		...
		CKEDITOR.dom.range.prototype = {
			...
			createBookmark: function (a) {
				...
				f.setHtml("\x26nbsp;");
				a && (h = "cke_bm_" + CKEDITOR.tools.getNextNumber(), f.setAttribute("id", h + (e ? "C" : "S")));
				e || (l = f.clone(), l.setHtml("\x26nbsp;"), a && l.setAttribute("id", h + "E"), k = this.clone(), b(d) && (d = b(d),
					k.moveToPosition(d, CKEDITOR.POSITION_AFTER_END)), k.collapse(), k.insertNode(l));
				k = this.clone();
				b(c) && (d = b(c), k.moveToPosition(d, CKEDITOR.POSITION_BEFORE_START));
				k.collapse(!0);
				k.insertNode(f);
				l ? (this.setStartAfter(f), this.setEndBefore(l)) : this.moveToPosition(f, CKEDITOR.POSITION_AFTER_END);
				return {
			...
			createBookmark2: function () {
				function a(b) {
					...
					e = g;
					var f = d;
					e = e.type != CKEDITOR.NODE_ELEMENT || 0 === f || f == e.getChildCount() ?
						0 : e.getChild(f - 1).type == CKEDITOR.NODE_TEXT && e.getChild(f).type == CKEDITOR.NODE_TEXT;
					...
					if (g.type == CKEDITOR.NODE_TEXT) {
						...
						e = f;
						g.isEmpty() ? (f = g.getPrevious(c), e ? (d = e, g = f ? f.getNext() : g.getParent().getFirst()) : (g = g.getParent(),
			...
			enlarge: function (a, b) {
				...
				switch (a) {
					...
					case CKEDITOR.ENLARGE_ELEMENT:
						...
						C.type == CKEDITOR.NODE_TEXT ? (t && (C = !CKEDITOR.tools.trim(C.substring(0, t)).length && C, E = !!C), C && ((u = C.getPrevious()) || (q = C.getParent()))) : (t && (u = C.getChild(t - 1) || C.getLast()), u || (q = C));
						for (q = c(q); q ||
							u;) {
							if (q && !u) {
								!K && q.equals(k) && (K = !0);
								if (h ? q.isBlockBoundary() : !l.contains(q)) break;
								E && "inline" == q.getComputedStyle("display") || (E = !1, K ? m = q : this.setStartBefore(q));
								u = q.getPrevious()
							}
							for (; u;)
								if (C = !1, u.type == CKEDITOR.NODE_COMMENT) u = u.getPrevious();
								else {
									if (u.type == CKEDITOR.NODE_TEXT) f = u.getText(), e.test(f) && (u = null), C = /[\s\ufeff]$/.test(f);
									else if ((u.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && u.is("br")) && !u.data("cke-bookmark"))
										if (E && CKEDITOR.dtd.$removeEmpty[u.getName()]) {
											f = u.getText();
											if (e.test(f)) u =
												null;
											else
												for (var t = u.$.getElementsByTagName("*"), B = 0, z; z = t[B++];)
													if (!CKEDITOR.dtd.$removeEmpty[z.nodeName.toLowerCase()]) {
														u = null;
														break
													} u && (C = !!f.length)
										} else u = null;
									C && (E ? K ? m = q : q && this.setStartBefore(q) : E = !0);
									if (u) {
										C = u.getPrevious();
										if (!q && !C) {
											q = u;
						...
						q = u = null;
						K = E = !1;
						C.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(C.substring(t)).length ? E = !0 : (E = !C.getLength(), t == C.getLength() ? (u = C.getNext()) || (q = C.getParent()) : d(C,
							t, l) && (q = C.getParent())) : (u = C.getChild(t)) || (q = C);
						for (; q || u;) {
							if (q && !u) {
								!K && q.equals(k) && (K = !0);
								if (h ? q.isBlockBoundary() : !l.contains(q)) break;
								E && "inline" == q.getComputedStyle("display") || (E = !1, K ? p = q : q && this.setEndAfter(q));
								u = q.getNext()
							}
							for (; u;) {
								C = !1;
								if (u.type == CKEDITOR.NODE_TEXT) f = u.getText(), d(u, 0, l) || (u = null), C = /^[\s\ufeff]/.test(f);
									...
									if ((0 < u.$.offsetWidth || b && u.is("br")) && !u.data("cke-bookmark"))
										if (E && CKEDITOR.dtd.$removeEmpty[u.getName()]) {
											...
											if (e.test(f)) u =
												...
												for (t = u.$.getElementsByTagName("*"), B = 0; z = t[B++];)
													if (!CKEDITOR.dtd.$removeEmpty[z.nodeName.toLowerCase()]) {
														u = null;
														break
													} u && (C = !!f.length)
						...
						m && p && (k = m.contains(p) ? p : m, this.setStartBefore(k), this.setEndAfter(k));
						break;
					...
					case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
						...
						var H, N, O = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {
							br: 1
						} : null),
							r = null,
							I = function (a) {
						...
						H = H || l;
						this.setStartAt(H,
							!H.is("br") && (!q && this.checkStartOfBlock() || q && H.contains(q)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END);
						...
						q = this.clone();
						q.collapse();
						q.setEndAt(l, CKEDITOR.POSITION_BEFORE_END);
						q = new CKEDITOR.dom.walker(q);
						q.guard =
							a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? h : I;
						H = r = N = null;
						q = q.lastForward();
						H = H || l;
			...
			shrink: function (a, b, c) {
				...
				if (!this.collapsed) {
					...
					var f = this.clone(),
						...
						m = this.endOffset,
						p = c = 1;
					l && l.type == CKEDITOR.NODE_TEXT && (k ? k >= l.getLength() ? f.setStartAfter(l) : (f.setStartBefore(l), c = 0) : f.setStartBefore(l));
					h && h.type == CKEDITOR.NODE_TEXT && (m ? m >= h.getLength() ? f.setEndAfter(h) : (f.setEndAfter(h), p = 0) : f.setEndBefore(h));
					...
					p && (f.reset(), (f = f[a == CKEDITOR.SHRINK_ELEMENT ? "lastBackward" : "previous"]()) && this.setEndAt(f, b ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_AFTER_END));
					return !(!c && !p)
				}
			},
			...
			splitBlock: function (a, b) {
				...
				"br" !=
					a && (e || (e = this.fixBlock(!0, a), f = (new CKEDITOR.dom.elementPath(this.endContainer, this.root)).block), f || (f = this.fixBlock(!1, a)));
				c = e && this.checkStartOfBlock();
				d = f && this.checkEndOfBlock();
				this.deleteContents();
				e && e.equals(f) && (d ? (l = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(f, CKEDITOR.POSITION_AFTER_END), f = null) : c ? (l = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(e, CKEDITOR.POSITION_BEFORE_START), e = null) : (f = this.splitElement(e, b ||
			...
			moveToElementEditablePosition: function (a, b) {
				...
				for (var c = 0; a;) {
					...
					var d = a,
						e = c,
						f = void 0;
					d.type == CKEDITOR.NODE_ELEMENT && d.isEditable(!1) && (f = d[b ? "getLast" : "getFirst"](m));
					e || f || (f = d[b ? "getPrevious" : "getNext"](m));
					a = f
				}
				return !!c
			},
			moveToClosestEditablePosition: function (a, b) {
				var c, d = 0,
					e, f, l = [CKEDITOR.POSITION_AFTER_END, CKEDITOR.POSITION_BEFORE_START];
			...
			getClientRects: function () {
				function a(b, c) {
					var d = CKEDITOR.tools.array.map(b, function (a) {
						...
						g, f, h;
					c.startContainer instanceof CKEDITOR.dom.element && (f = 0 === c.startOffset && c.startContainer.hasAttribute("data-widget"));
					...
					f && e.setStart(c.startContainer.getParent(),
					...
					if (e = CKEDITOR.tools.array.map(e, function (a) {
						...
						function b(e) {
							CKEDITOR.tools.array.forEach(d, function (b, g) {
								...
								f && (Array.prototype.splice.call(d, g, a.length - e, a.widgetRect), c = !0)
							});
				...
				return void 0 !== document.getSelection ? function (d) {
					...
					return CKEDITOR.tools.array.map(f, function (a) {
						return c(a, d, this)
					},
						this)
				} : function (a) {
			...
			_find: function (a, b) {
				var c = this.getCommonAncestor(),
					...
					f, l, h, k;
				if (c && c.find)
					for (l = c.find(a), f = 0; f < l.count(); f++)
						if (c = l.getItem(f), b || !c.isReadOnly()) h = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c), k = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED ||
		...
		a.prototype = {
			getNextParagraph: function (a) {
				...
				if (!this._.started) {
					...
					k = v.startPath();
					var l = v.endPath(),
						L = !v.collapsed && c(v, k.block),
						w = !v.collapsed && c(v, l.block, 1);
					v.shrink(CKEDITOR.SHRINK_ELEMENT, !0);
					L && v.setStartAt(k.block, CKEDITOR.POSITION_BEFORE_END);
					w && v.setEndAt(l.block, CKEDITOR.POSITION_AFTER_START);
					...
					v.collapsed || (k = new CKEDITOR.dom.walker(v.clone()), l = CKEDITOR.dom.walker.bookmark(!0, !0), k.evaluator = l, this._.nextNode = k.next(), k = new CKEDITOR.dom.walker(v.clone()), k.evaluator = l, k = k.previous(), this._.lastNode = k.getNextSourceNode(!0, null, v.root), this._.lastNode && this._.lastNode.type == CKEDITOR.NODE_TEXT && !CKEDITOR.tools.trim(this._.lastNode.getText()) && this._.lastNode.getParent().isBlockBoundary() && (l = this.range.clone(), l.moveToPosition(this._.lastNode, CKEDITOR.POSITION_AFTER_END), l.checkEndOfBlock() &&
						(l = new CKEDITOR.dom.elementPath(l.endContainer, l.root), this._.lastNode = (l.block || l.blockLimit).getNextSourceNode(!0))), this._.lastNode && v.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = v.document.createText(""), this._.lastNode.insertAfter(k)), v = null);
					this._.started = 1;
					k = v
				}
				l = this._.nextNode;
				...
				for (this._.nextNode = null; l;) {
					var L = 0,
						w = l.hasAscendant("pre"),
						J = l.type != CKEDITOR.NODE_ELEMENT,
						G = 0;
					if (J) l.type == CKEDITOR.NODE_TEXT && f.test(l.getText()) && (J = 0);
					else {
						var q = l.getName();
						if (CKEDITOR.dtd.$block[q] && "false" == l.getAttribute("contenteditable")) {
							d = l;
							b(this, a, d);
							break
						} else if (l.isBlockBoundary(this.forceBrBreak && !w && {
							br: 1
						})) {
							if ("br" == q) J = 1;
							else if (!k && !l.getChildCount() && "hr" != q) {
								d = l;
								y = l.equals(v);
								break
							}
							k && (k.setEndAt(l, CKEDITOR.POSITION_BEFORE_START), "br" != q && (this._.nextNode = l));
							L = 1
						} else {
							if (l.getFirst()) {
								k || (k = this.range.clone(), k.setStartAt(l, CKEDITOR.POSITION_BEFORE_START));
								l = l.getFirst();
								continue
							}
							J = 1
					...
					J && k.setEndAt(l, CKEDITOR.POSITION_AFTER_END);
					l = this._getNextSourceNode(l, G, v);
					if ((y = !l) || L && k) break
				}
				if (!d) {
				...
				F && (A = d.getLast()) && A.type == CKEDITOR.NODE_ELEMENT && "br" == A.getName() && (!CKEDITOR.env.needsBrFiller || A.getPrevious(e) || A.getNext(e)) && A.remove();
				this._.nextNode || (this._.nextNode = y || d.equals(v) || !v ? null : this._getNextSourceNode(d, 1, v));
				return d
			},
	...
	(function () {
		function a(a, b, c, d, e) {
			...
			for (f in b) {
				...
				for (r in N) {
					...
					var l = n,
						...
						I = void 0;
					h ? H = !1 : h = {};
					for (I in E) "!" == I.charAt(0) && (I = I.slice(1), D.push(I), h[I] = !0, H = !1);
					for (; I = D.pop();) E[I] =
						E["!" + I], delete E["!" + I];
					l[z] = (H ? !1 : h) || null
				}
			...
			for (d = a.length; c < d; ++c) {
				...
				for (r in O) {
					...
					h = [];
					E = void 0;
					for (E in z) - 1 < E.indexOf("*") ? h.push(new RegExp("^" + E.replace(/\*/g, ".*") + "$")) : h.push(E);
					z = h;
					z.length && (n[t] = z, l = !1)
				}
				n.nothingRequired = l;
				...
				if (!0 === f.elements ||
					...
					for (C in n = f.elements, delete f.elements, n)
						if (b[C]) b[C][g ? "unshift" : "push"](f);
						else b[C] = [f]
			}
		}
		...
		function g(a) {
			var b, c, d, e, f = {},
				g = 1;
			for (a = z(a); b = a.match(r);)(c = b[2]) ? (d = x(c, "styles"), e = x(c, "attrs"), c = x(c, "classes")) : d = e = c = null, f["$" + g++] = {
				elements: b[1],
				classes: c,
				styles: d,
				attributes: e
		...
		function A(a, b, e, f) {
			var g = 0,
				t;
			f.toHtml && (b.name = b.name.replace(M, "$1"));
			if (f.doCallbacks && a.elementCallbacks) {
				a: {
					t = a.elementCallbacks;
					for (var r = 0, z = t.length, B; r < z; ++r)
						if (B = t[r](b)) {
							t = B;
							break a
						} t = void 0
			...
			if (f.doFilter) {
				a: {
					...
					if (a || t) {
						y(b);
						if (r)
							for (h = 0, E = r.length; h < E; ++h)
								if (!1 === c(r[h], b, k)) {
									a = null;
									break a
								} if (z)
							for (h = 0, E = z.length; h < E; ++h) c(z[h], b, k);
						if (a)
							for (h = 0, E = a.length; h < E; ++h) d(a[h], b, k, B);
						if (t)
							for (h = 0, E = t.length; h < E; ++h) d(t[h], b, k, B);
						a = k
					} else a = null
				}
				...
				var r = b.attributes,
					H = b.styles,
					z = b.classes; B = b.classBackup;
				var O = b.styleBackup,
					I, C, N = [],
					k = [],
					m = /^data-cke-/; h = !1; delete r.style; delete r["class"]; delete b.classBackup; delete b.styleBackup;
				if (!a.allAttributes)
					for (I in r) E[I] || (m.test(I) ? I == (C = I.replace(/^data-cke-saved-/, "")) || E[C] || (delete r[I], h = !0) : (delete r[I], h = !0));
				if (!a.allStyles || a.hadInvalidStyle) {
					for (I in H) a.allStyles || D[I] ? N.push(I + ":" + H[I]) : h = !0;
					N.length && (r.style = N.sort().join("; "))
				} else O && (r.style = O);
				if (!a.allClasses ||
					a.hadInvalidClass) {
					for (I = 0; I < z.length; ++I)(a.allClasses || t[z[I]]) && k.push(z[I]);
					k.length && (r["class"] = k.sort().join(" "));
					B && k.length < B.split(/\s+/).length && (h = !0)
				} else B && (r["class"] = B); h && (g = 1);
				if (!f.skipFinalValidation && !l(b)) return e.push(b),
					1
			}
			...
			if (t.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(w()) : (a.parent && c.push({
				...
				if ("br" == b) a.previous && !J(a.previous) && (b = w(), b.insertBefore(a)), a.next && !J(a.next) && (b = w(), b.insertAfter(a)), a.replaceWithChildren();
					...
					if (e) a.name = b, a.attributes = {}, c.push({
						...
						e = a.parent;
						for (var f = e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == e.name, r, z, g = d.length; 0 < g;) n = d[--g], f && (n.type == CKEDITOR.NODE_TEXT || n.type == CKEDITOR.NODE_ELEMENT && t.$inline[n.name]) ? (r || (r = new CKEDITOR.htmlParser.element(b), r.insertAfter(a), c.push({
							check: "parent-down",
							el: r
						})), r.add(n, 0)) : (r = null, z = t[e.name] || t.span, n.insertAfter(a), e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || n.type != CKEDITOR.NODE_ELEMENT || z[n.name] || c.push({
							check: "el-up",
							el: n
						}));
						a.remove()
		...
		function u(a, b) {
			...
			for (f in d)
				if ("class" == f)
					for (c = d[f].split(/\s+/), n = a.classes.join("|"); t = c.pop();) {
		...
		CKEDITOR.filter = function (a, b) {
			...
			if (c && !b) {
				...
				!0 === d ? this.disabled = !0 : (d || (this.customConfig = !1), this.allow(d, "config", 1), this.allow(c.config.extraAllowedContent, "extra", 1), this.allow(H[c.enterMode] +
		...
		CKEDITOR.filter.prototype = {
			...
			applyTo: function (a, b, c, d) {
						...
						a: {
							...
							if (g)
								for (l = 0; l < g.length; ++l)
									if ((B = d.match(g[l])) && B[0].length == d.length) {
										c = !0;
										break a
				...
				for (var h; c = f.pop();) c.type == CKEDITOR.NODE_ELEMENT ? G(c, d, a) : c.remove();
				for (; B = a.pop();)
					if (c = B.el, c.parent) switch (h = t[c.parent.name] || t.span, B.check) {
						case "it":
							t.$removeEmpty[c.name] && !c.children.length ? G(c, d, a) : l(c) || G(c, d, a);
							break;
						case "el-up":
							c.parent.type ==
								CKEDITOR.NODE_DOCUMENT_FRAGMENT || h[c.name] || G(c, d, a);
							break;
						case "parent-down":
							c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || h[c.name] || G(c.parent, d, a)
					}
				return r
			},
				...
				if (!this.disabled && a) {
					...
					for (e = 0; e < a.length; ++e) {
						...
						var f = void 0,
							...
							z = void 0;
						c = [];
						for (g = 0; g < b.length; ++g) n = b[g], "string" == typeof n ? (n = n.split(/\s*:\s*/), t = n[0], r = null, z = n[1]) : (t = n.check, r = n.left, z = n.right), f || (f = n, f = f.element ? f.element : t ? t.match(/^([a-z0-9]+)/i)[0] :
							f.left.getDefinition().element), r instanceof CKEDITOR.style && (r = E(r)), c.push({
								check: t == f ? null : t,
								left: r,
								right: "string" == typeof z ? C(z) : z
							});
						b = f;
						d[b] || (d[b] = []);
						d[b].push(c)
			...
			check: function (a, b, c) {
				...
				} else e = a.getDefinition(), n = e.styles, d = e.attributes || {}, n && !CKEDITOR.tools.isEmpty(n) ? (n = B(n), d.style = CKEDITOR.tools.writeCssText(n, !0)) : n = {}, e = {
					name: e.element,
					attributes: d,
				...
				0 < t.length ? c = !1 : ((b = e.attributes["class"]) && (e.attributes["class"] = e.attributes["class"].split(" ").sort().join(" ")), c = CKEDITOR.tools.objectCompare(e.attributes, n.attributes, !0), b && (e.attributes["class"] = b));
		...
		var N = {
			...
			r = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i,
			I = {
				styles: /{([^}]+)}/,
				attrs: /\[([^\]]+)\]/,
				classes: /\(([^\)]+)\)/
			...
			transform: function (a, b) {
				if ("string" == typeof b) a.name = b;
					...
					for (f in e)
						if ("class" ==
							f)
							for (c = a.classes.join("|"), n = e[f].split(/\s+/); t = n.pop();) - 1 == c.indexOf(t) && a.classes.push(t);
		...
		return {
			load: function (b, c, f, e) {
				...
				var h = b.length,
					...
					g = [],
					x = function (a) {
						c && (k ? c.call(f, a) : c.call(f, m, g))
					};
				if (0 === p) x(!0);
				else {
					var y = function (a, b) {
						(b ? m : g).push(a);
						0 >= --p && (e && CKEDITOR.document.getDocumentElement().removeStyle("cursor"), x(b))
					},
						A = function (b, c) {
							a[b] = 1;
							var e = d[b];
	...
	CKEDITOR.resourceManager.prototype = {
		...
		load: function (a, d, b) {
			...
			for (var c = this.loaded, f = this.registered, e = [], k = {}, h = {}, p = 0; p < a.length; p++) {
				var m = a[p];
				if (m)
					if (c[m] || f[m]) h[m] = this.get(m);
					else {
				...
				k = function (b) {
					a.call(this, b, function (a) {
						...
						for (g in a) {
							...
							if (!d[g]) {
								if (h.icons)
									for (var A = h.icons.split(","), F = A.length; F--;) CKEDITOR.skin.addIcon(A[F], h.path + "icons/" + (CKEDITOR.env.hidpi && h.hidpi ? "hidpi/" : "") + A[F] + ".png");
						...
						if (b.length) k.call(this, b);
							...
							for (g in e) h = e[g], h.onLoad && !h.onLoad._called && (!1 === h.onLoad() && delete e[g], h.onLoad._called = 1);
							c && c.call(f || window, e)
						}
					}, this)
				};
	...
	(function () {
		...
		function m(a) {
			CKEDITOR.lang.load(a.config.language, a.config.defaultLanguage, function (b, c) {
				var d = a.config.title,
					e = a.config.applicationTitle;
				a.langCode = b;
				a.lang = CKEDITOR.tools.prototypedCopy(c);
				a.title = "string" == typeof d || !1 === d ? d : [a.lang.editor, a.name].join(", ");
				a.applicationTitle = "string" == typeof e || !1 === e ? e : [a.lang.application, a.name].join(", ");
				a.config.contentsLangDirection || (a.config.contentsLangDirection = a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ?
					a.element.getDirection(1) : a.lang.dir);
				a.fire("langLoaded");
				g(a)
			})
		}
		...
		function x(a) {
			...
			CKEDITOR.plugins.load(d.split(","), function (b) {
				...
				for (var g in b) {
					...
					if (r && (I = r.match(h)))
						for (; r = I.pop();) CKEDITOR.error("editor-plugin-required", {
							plugin: r.replace(",", ""),
							requiredBy: g
						});
					N && !a.lang[g] && (N.split && (N = N.split(",")), 0 <= CKEDITOR.tools.indexOf(N, a.langCode) ?
						O = a.langCode : (O = a.langCode.replace(/-.*/, ""), O = O != a.langCode && 0 <= CKEDITOR.tools.indexOf(N, O) ? O : 0 <= CKEDITOR.tools.indexOf(N, "en") ? "en" : N[0]), k.langEntries && k.langEntries[O] ? (a.lang[g] = k.langEntries[O], O = null) : f.push(CKEDITOR.getUrl(k.path + "lang/" + O + ".js")));
					e.push(O);
					d.push(k)
				}
					...
					if (!a.isDestroyed() && !a.isDetached()) {
						for (var b = ["beforeInit", "init", "afterInit"], f = 0; f < b.length; f++)
							for (var g = 0; g < d.length; g++) {
								var r = d[g];
								0 === f && e[g] && r.lang && r.langEntries && (a.lang[r.name] =
									r.langEntries[e[g]]);
								if (r[b[f]]) r[b[f]](a)
							}
		...
		function A(a, b) {
			function c(a) {
				...
				b = f && 1 === b.getChildCount() && "img" === b.getChildren().getItem(0).getName();
				return e || a && !b ? !0 : !1
			}
			...
			for (var e = new CKEDITOR.dom.documentFragment, f, g, h, k = 0; k < a.length; k++) {
				var C = a[k],
					t = C.startContainer.getAscendant("tr",
						!0);
				c(C) ? (f || (f = t.getAscendant("table").clone(), f.append(t.getAscendant({
					thead: 1,
					tbody: 1,
					tfoot: 1
				}).clone()), e.append(f), f = f.findOne("thead, tbody, tfoot")), g && g.equals(t) || (g = t, h = t.clone(), f.append(h)), h.append(d(C))) : e.append(C.cloneContents())
			}
		...
		CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
			...
			_attachToForm: function () {
				...
				d.is("textarea") && e && (e.on("submit", a), b(e.$.submit) && (e.$.submit =
					CKEDITOR.tools.override(e.$.submit, function (b) {
						return function () {
							a();
			...
			getSnapshot: function () {
				...
				"string" != typeof a && (a = (a = this.element) && this.elementMode ==
					CKEDITOR.ELEMENT_MODE_REPLACE ? a.is("textarea") ? a.getValue() : a.getHtml() : "");
				return a
			},
			...
			extractSelectedHtml: function (a,
				b) {
				var c = this.editable(),
		...
		CKEDITOR.editor.initializeDelayedEditorCreation = function (a, b, c) {
			if (b.delayIfDetached_callback) return CKEDITOR.warn("editor-delayed-creation", {
				method: "callback"
			...
			var d = void 0 === b.delayIfDetached_interval ? CKEDITOR.config.delayIfDetached_interval : b.delayIfDetached_interval;
						...
						if (f = f.toLowerCase(), !/="/.test(f)) {
							...
							if (m)
								for (; p = a.exec(m);) {
									...
									p = p[2] || p[3] || p[4] || "";
									h[g] = !p && d[g] ? g : CKEDITOR.tools.htmlDecodeAttr(p)
								}
		...
		CKEDITOR.htmlParser.fragment.fromHtml =
			function (e, k, h) {
				function p(a) {
					...
					if (0 < l.length)
						for (var c = 0; c < l.length; c++) {
							...
							g && !g[e] || a && f && !f[a] && CKEDITOR.dtd[a] ? e == w.name && (x(w, w.parent, 1), c--) : (b || (m(), b = 1), d = d.clone(), d.parent = w, w = d, l.splice(c, 1), c--)
						}
				}

				function m() {
					for (; L.length;) x(L.shift(), w)
				}
				...
				function x(b, c, d) {
					c = c || w || v;
					var e = w;
					void 0 === b.previous && (y(c, b) && (w = c, F.onTagOpen(h, {}), b.returnPoint = c = w), g(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (G = !1), "textarea" == b.name && (J = !1));
				...
				F.onTagOpen = function (e, f, g, h) {
					...
					if (a(f)) l.push(f);
						...
						if ("br" == e) L.push(f);
							...
							for (; !(h = (g = w.name) ? CKEDITOR.dtd[g] || (w._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, f.isUnknown || w.isUnknown || h[e]);)
								if (w.isOptionalClose) F.onTagClose(g);
								else if (e in b && g in b) g = w.children, (g = g[g.length - 1]) && "li" == g.name || x(g = new CKEDITOR.htmlParser.element("li"), w), !f.returnPoint && (f.returnPoint = w), w = g;
								else if (e in CKEDITOR.dtd.$listItem &&
									!A(e, g)) F.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1);
								else if (g in d && !A(e, g)) !f.returnPoint && (f.returnPoint = w), w = w.parent;
								else if (g in CKEDITOR.dtd.$inline && l.unshift(w), w.parent) x(w, w.parent, 1);
								else {
									f.isOrphan = 1;
									break
								}
				...
				F.onTagClose = function (a) {
					for (var b = l.length - 1; 0 <= b; b--)
						if (a == l[b].name) {
							l.splice(b, 1);
							return
						} for (var c = [], d = [], e = w; e != v && e.name != a;) e._.isBlockLike || d.unshift(e), c.push(e), e = e.returnPoint || e.parent;
					if (e != v) {
						...
						w =
							e;
						e._.isBlockLike ? m() : (b = CKEDITOR.config.shiftLineBreaks, !0 !== b && L.length && ("function" !== typeof b ? m() : (b = b(L[L.length - 1]), !0 !== b && (m(), b instanceof CKEDITOR.htmlParser.text && w.add(b), b instanceof CKEDITOR.htmlParser.element && x(b, w)))));
						x(e, e.parent);
						e == w && (w = w.parent);
						l = l.concat(d)
					}
				...
				F.onText = function (a) {
					if (!(w._.hasInlineStarted && !L.length || G || J) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return;
					var b = w.name,
						e = b ? CKEDITOR.dtd[b] || (w._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) :
							c;
					if (!J && !e["#"] && b in d) F.onTagOpen(f[b] || ""), F.onText(a);
					else {
						m();
						p();
						G || J || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
	...
	(function () {
		...
		a.prototype = {
			...
			addMany: function (a,
				c, d) {
				for (var e = [this.findIndex(c), 0], k = 0, h = a.length; k < h; k++) e.push({
					value: a[k],
					priority: c,
					options: d
				});
			...
			exec: function (a, c) {
				var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
					...
					p, m, g, x;
				for (x = 0; x < h; x++)
					if (d && (p = c.type, m = c.name), g = k[x], !(a.nonEditable && !g.options.applyToAll ||
						a.nestedEditable && g.options.excludeNestedEditable)) {
						g = g.value.apply(null, e);
						if (!1 === g || d && g && (g.name != m || g.type != p)) return g;
						null != g && (e[0] = c = g)
					} return c
			},
			execOnName: function (a, c) {
				for (var d = 0, e = this.rules, k = e.length, h; c && d < k; d++) h = e[d], a.nonEditable && !h.options.applyToAll || a.nestedEditable && h.options.excludeNestedEditable || (c = c.replace(h.value[0], h.value[1]));
				return c
			}
		}
	})();
	(function () {
		function a(a, d) {
				...
				return function (f) {
					if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
						var n = [],
							...
							z, B;
						if (t)
							for (r(t, 1) && n.push(t); t;) e(t) && (z = c(t)) && r(z) && ((B = c(z)) && !e(B) ? n.push(z) : (g(h).insertAfter(z), z.remove())), t = t.previous;
						for (t = 0; t < n.length; t++) n[t].remove();
						if (n = !a || !1 !== ("function" == typeof d ? d(f) : d)) h || CKEDITOR.env.needsBrFiller ||
							f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? h || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || f.name in CKEDITOR.dtd.tr || f.name in CKEDITOR.dtd.$listItem) ? (n = b(f), n = !n || "form" == f.name && "input" == n.name) : n = !1 : n = !1;
						n && f.add(g(a))
					}
				}
			}
			...
			var z = {
				...
				h = "html" == d,
				B = CKEDITOR.tools.extend({}, q),
				E;
			for (E in B) "#" in J[E] || delete B[E];
			for (E in B) z.elements[E] = t(h, a.config.fillEmptyBlocks);
			z.root = t(h, !1);
			z.elements.br = function (a) {
				return function (b) {
					if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
						...
						if ("data-cke-bogus" in d || "data-cke-eol" in d) delete d["data-cke-bogus"];
							...
							for (d = b.next; d && f(d);) d =
								d.next;
							var n = c(b);
							!d && e(b.parent) ? k(b.parent, g(a)) : e(d) && n && !e(n) && g(a).insertBefore(d)
						}
					}
				}
			}(h);
		...
		CKEDITOR.htmlDataProcessor =
			function (b) {
				...
				b.on("toHtml", function (a) {
					...
					c = e ? e.getRandomValues(new Uint32Array(1))[0] : Math.floor(9E9 * Math.random() + 1E9);
					a = a.data;
					var e = a.dataValue,
						e = l(e),
						e = v(e, b, c),
					...
					e = e.replace(new RegExp("data-cke-" +
						c + "-", "ig"), "");
					...
					c && (t = e, !t.children.length && CKEDITOR.dtd[t.name][c] && (c = new CKEDITOR.htmlParser.element(c), t.add(c)));
					a.dataValue = e
				}, null, null, 5);
				b.on("toHtml", function (a) {
		...
		CKEDITOR.htmlDataProcessor.prototype = {
			toHtml: function (a, b, c, d) {
				var e = this.editor,
					f, g, t, r;
				b && "object" == typeof b ? (f = b.context, c = b.fixForBody, d = b.dontFilter, g = b.filter, t = b.enterMode, r = b.protectedWhitespaces) : f = b;
				f || null === f || (f =
					e.editable().getName());
		...
		var L = /(?:&nbsp;|\xa0)$/,
			w = "{cke_protected}",
			J = CKEDITOR.dtd,
			G = "caption colgroup col thead tfoot tbody".split(" "),
				...
				elements: {
					...
					table: function (a) {
						a.children.slice(0).sort(function (a, b) {
							var c, d;
							a.type == CKEDITOR.NODE_ELEMENT && b.type == a.type && (c = CKEDITOR.tools.indexOf(G, a.name), d = CKEDITOR.tools.indexOf(G, b.name)); - 1 < c && -1 < d && c != d || (c = a.parent ? a.getIndex() : -1, d = b.parent ? b.getIndex() : -1);
							return c > d ? 1 : -1
						})
					},
					param: function (a) {
	...
	(function () {
		...
		CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
			...
			filter: function (a, b) {
				...
				for (p in k) {
					for (h = k[p]; ;)
						if (m = a.onAttributeName(b, p))
							if (m != p) delete k[p], p = m;
							else break;
						else {
							delete k[p];
							break
						}
					m && (!1 === (h = a.onAttribute(b, d, m, h)) ? delete k[m] : k[m] = h)
				}
				d.isEmpty ||
					this.filterChildren(a, !1, b);
				return !0
			...
			writeHtml: function (a, b) {
				...
				p = 0;
				for (m = k.length; p < m; p++) h = k[p], a.attribute(h[0], h[1]);
	...
	(function () {
		CKEDITOR.inline = function (a, d) {
			...
			if (!a) return null;
			if (CKEDITOR.editor.shouldDelayEditorCreation(a, d)) return CKEDITOR.editor.initializeDelayedEditorCreation(a, d, "inline");
		...
		CKEDITOR.inlineAll = function () {
			...
			for (b in CKEDITOR.dtd.$editable)
				for (var c = CKEDITOR.document.getElementsByTag(b), f = 0, e = c.count(); f < e; f++) a = c.getItem(f), "true" != a.getAttribute("contenteditable") || a.getEditor() || (d = {
					element: a,
					config: {}
	...
	(function () {
		function a(a, f, e, k) {
			a = CKEDITOR.editor._getEditorElement(a);
			if (!a) return null;
			if (CKEDITOR.editor.shouldDelayEditorCreation(a, f)) return CKEDITOR.editor.initializeDelayedEditorCreation(a, f, "replace");
			...
			h.on("loaded", function () {
				h.isDestroyed() || h.isDetached() || (b(h), k == CKEDITOR.ELEMENT_MODE_REPLACE &&
					h.config.autoUpdateElement && a.$.form && h._attachToForm(), h.setMode(h.config.startupMode, function () {
						h.resetDirty();
						h.status = "ready";
		...
		CKEDITOR.editor.prototype.resize = function (a, b, d, k) {
			...
			var g = (k.$.offsetHeight || 0) - (p.$.clientHeight || 0),
				h = Math.max(b - (d ? 0 : g), 0);
			b = d ? b + g : b;
			p.setStyle("height",
				CKEDITOR.tools.cssLength(h));
			m && (m.style.width = "100%");
			this.fire("resize", {
				outerHeight: b,
				contentsHeight: h,
	...
	(function () {
		function a(a) {
			...
			if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller)
				if (f = d(f, e)) f.appendBogus(), k = CKEDITOR.env.ie && !CKEDITOR.env.edge || CKEDITOR.env.edge && b._.previousActive;
			p(b, e.block, g) && h.collapsed && !h.getCommonAncestor().isReadOnly() && (e = h.clone(), e.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), g = new CKEDITOR.dom.walker(e), g.guard = function (a) {
				return !c(a) || a.type == CKEDITOR.NODE_COMMENT || a.isReadOnly()
			},
				!g.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock()) && (b = h.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p"), CKEDITOR.env.needsBrFiller || (b = b.getFirst(c)) && b.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(b.getText()).match(/^(?:&nbsp;|\xa0)$/) && b.remove(), k = 1, a.cancel());
			k && h.select()
		}
		...
		function k(a) {
			function b(a) {
				...
				return function (b, g) {
					...
					if (!(g || !c(b) || a && l(b))) return !1
				}
			}
			var d, g = a.getRanges()[0],
				f = a.root;
			return e(a) && (a = g.clone(), a.collapse(1), a.setStartAt(f, CKEDITOR.POSITION_AFTER_START), f = new CKEDITOR.dom.walker(a), f.guard = b(), f.checkBackward(), d) ? (a = g.clone(), a.collapse(), a.setEndAt(d, CKEDITOR.POSITION_AFTER_END), f = new CKEDITOR.dom.walker(a), f.guard = b(!0), d = !1, f.checkForward(), d) : null
		}
		...
		CKEDITOR.editable = CKEDITOR.tools.createClass({
			...
			proto: {
				focus: function () {
					...
					CKEDITOR.env.edge && 14 < CKEDITOR.env.version &&
						!this.hasFocus && this.getDocument().equals(CKEDITOR.document) && (this.editor._.previousScrollTop = this.$.scrollTop);
					try {
					...
					CKEDITOR.env.safari && !this.isInline() && (a = CKEDITOR.document.getActive(), a.equals(this.getWindow().getFrame()) ||
						this.getWindow().focus())
				},
				on: function (a, b) {
				...
				insertElement: function (a, b) {
					...
					this.insertElementIntoRange(a, b) && (b.moveToPosition(a, CKEDITOR.POSITION_AFTER_END), g && ((g = a.getNext(function (a) {
						return c(a) && !l(a)
					})) && g.type == CKEDITOR.NODE_ELEMENT && g.is(CKEDITOR.dtd.$block) ? g.getDtd()["#"] ? b.moveToElementEditStart(g) : b.moveToElementEditEnd(a) :
						g || e == CKEDITOR.ENTER_BR || (g = b.fixBlock(!0, e == CKEDITOR.ENTER_DIV ? "div" : "p"), b.moveToElementEditStart(g))));
					d.selectRanges([b]);
					x(this)
				},
				...
				insertElementIntoRange: function (a, b) {
					...
					b.startContainer.type == CKEDITOR.NODE_ELEMENT && (b.startContainer.is({
						...
						thead: 1,
						tfoot: 1
					}) ? J(b) : b.startContainer.is(CKEDITOR.dtd.$list) &&
					G(b));
					var h, k;
					if (f)
						for (;
							(h = b.getCommonAncestor(0, 1)) && (k = CKEDITOR.dtd[h.getName()]) && (!k || !k[e]);)
							if (h.getName() in CKEDITOR.dtd.span) {
								...
								g(f);
								b.moveToBookmark(r)
							} else b.checkStartOfBlock() && b.checkEndOfBlock() ? (b.setStartBefore(h), b.collapse(!0), h.remove()) : b.splitBlock(d == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable());
					b.insertNode(a);
					return !0
				},
				...
				fixInitialSelection: function () {
					function a() {
						...
						a: if (d.anchorNode && d.anchorNode == c.$) e = !0;
							...
							e = void 0
						} e && (e = new CKEDITOR.dom.range(c), e.moveToElementEditStart(c), b = b.createRange(), b.setStart(e.startContainer.$, e.startOffset),
				...
				setup: function () {
					...
					this.attachListener(a, "beforeGetData", function () {
						var b = this.getData();
						this.is("textarea") || !1 !== a.config.ignoreEmptyParagraph && (b = b.replace(L, function (a, b) {
							return b
						}));
						a.setData(b, null, 1)
					}, this);
					...
					if (!this.is("textarea")) {
						...
						var z = CKEDITOR.getCss();
						if (z) {
							var f = g.getHead(),
								H = f.getCustomData("stylesheet");
							H ? z != H.getText() && (CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? H.$.styleSheet.cssText = z : H.setText(z)) : (z = g.appendStyleText(z), z = new CKEDITOR.dom.element(z.ownerNode || z.owningElement), f.setCustomData("stylesheet",
								z), z.data("cke-temp", 1))
						}
							...
							if (0 !== g.getRanges().length) {
								if (c in
									...
									var t = b.startPath(),
										z, B, H, c = 8 == c,
										m = !1;
									if (CKEDITOR.env.ie && 11 > CKEDITOR.env.version && g.getSelectedElement()) f = g.getSelectedElement();
									else if (e(g)) {
										var l = new CKEDITOR.dom.walker(b),
											p = b.collapsed ? b.startContainer : l.next(),
											m = !1,
											C;
										if (b.checkStartOfBlock()) {
											C = b.startPath().block || b.startPath().blockLimit;
											var q = C.getName();
											C = -1 !== CKEDITOR.tools.array.indexOf(["dd", "dt", "li"], q) && null === C.getPrevious()
										} else C = !1;
										if (C) {
						...
						CKEDITOR.env.gecko && this.attachListener(this, "mouseup", function (b) {
							if (2 ==
								b.data.$.button && (b = b.data.getTarget(), !b.getAscendant("table") && !b.getOuterHtml().replace(L, ""))) {
								var c = a.createRange();
			...
			_: {
				cleanCustomData: function () {
					...
					this.restoreAttrs();
					for (var a = this.removeCustomData("classes"); a &&
						a.length;) this.removeClass(a.pop());
					if (!this.is("textarea")) {
						var a = this.getDocument(),
							b = a.getHead();
		...
		CKEDITOR.editor.prototype.editable = function (a) {
			...
			a ? b = a instanceof CKEDITOR.editable ? a : new CKEDITOR.editable(this, a) : (b && b.detach(), b =
				null);
		...
		w =
			function () {
				...
				function b(c, d) {
					...
					e = d.range.startPath();
					for (var t = l[t.getName()], k = 0, z = c.getChildren(), B = z.count(), H = -1, I = -1, M = 0, N = e.contains(l.$list); k < B; ++k) e = z.getItem(k), a(e) ? (f = e.getName(), N && f in CKEDITOR.dtd.$list ? r = r.concat(b(e, d)) : (h = !!t[f], "br" != f || !e.data("cke-eol") || k && k != B - 1 || (M = (g = k ? r[k - 1].node : z.getItem(k + 1)) && (!a(g) || !g.is("br")), g = g && a(g) && l.$block[g.getName()]), -1 != H || h || (H = k), h || (I = k), r.push({
						isElement: 1,
						isLineBreak: M,
						...
						node: e,
						allowed: 1
					}); - 1 < H && (r[H].firstNotAllowed = 1); - 1 < I && (r[I].lastNotAllowed = 1);
					return r
				}
				...
				function d(b, c) {
					var e = [],
						...
						r, h = 0,
						k = l[c],
						z = !b.is(l.$inline) || b.is("br");
					for (z && e.push(" "); h < f; h++) r = g.getItem(h), a(r) && !r.is(k) ? e = e.concat(d(r, c)) : e.push(r);
					z && e.push(" ");
					return e
				}
				...
				function h(b, c, d, e) {
					var g = b.clone(),
						f, t;
					g.setEndAt(c, CKEDITOR.POSITION_BEFORE_END);
					(f = (new CKEDITOR.dom.walker(g)).next()) && a(f) && r[f.getName()] && (t = f.getPrevious()) && a(t) && !t.getParent().equals(b.startContainer) && d.contains(t) && e.contains(f) && f.isIdentical(t) && (f.moveChildren(t), f.remove(), h(b, c, d, e))
				}
				...
				var l = CKEDITOR.dtd,
					...
					M = CKEDITOR.tools.extend({}, l.$inline);
				delete M.br;
				return function (r, D, R, q) {
					var x = r.editor,
						v = !1,
						y;
					"unfiltered_html" == D && (D = "html", v = !0);
					if (!q.checkReadOnly()) {
						...
						if (!v.collapsed) {
							w = W.block || W.blockLimit;
							var Z = v.getCommonAncestor();
							w && !w.equals(Z) && !w.contains(Z) && v.checkEndOfBlock() && D.zombies.push(w);
							v.deleteContents()
						}
						for (;
							(K = e(v)) && a(K) && K.isBlockBoundary() && F.contains(K);) v.moveToPosition(K, CKEDITOR.POSITION_BEFORE_END);
						h(v, D.blockLimit, F, W);
						T && (v.setEndBefore(T), v.collapse(), T.remove());
						T = v.startPath();
						if (w = T.contains(f, !1, 1)) y = v.splitElement(w), D.inlineStylesRoot = w, D.inlineStylesPeak = T.lastElement;
						T = v.createBookmark();
						u && (g(w), g(y));
						(w = T.startNode.getPrevious(c)) && a(w) && f(w) && A.push(w);
						(w = T.startNode.getNext(c)) && a(w) &&
							f(w) && A.push(w);
						for (w = T.startNode;
							(w = w.getParent()) && f(w);) A.push(w);
						v.moveToBookmark(T);
						y = r.getHtml();
						y = "" === y || y.match(L);
						x.enterMode === CKEDITOR.ENTER_DIV && y && ((x = r.getFirst()) && x.remove(), q.setStartAt(r, CKEDITOR.POSITION_AFTER_START), q.collapse(!0));
						if (r = R) {
							r = D.range;
							if ("text" == D.type && D.inlineStylesRoot) {
								q = D.inlineStylesPeak;
								x = q.getDocument().createText("{cke-peak}");
								for (y = D.inlineStylesRoot.getParent(); !q.equals(y);) x = x.appendTo(q.clone()), q = q.getParent();
								R = x.getOuterHtml().split("{cke-peak}").join(R)
							}
							q =
							...
							if ((J = r.startPath().block) && (1 != J.getChildCount() || !J.getBogus())) a: {
								var Q;
								if (1 ==
									q.getChildCount() && a(Q = q.getFirst()) && Q.is(I) && !Q.hasAttribute("contenteditable")) {
									J = Q.getElementsByTag("*");
									r = 0;
									for (y = J.count(); r < y; r++)
										if (x = J.getItem(r), !x.is(M)) break a;
						...
						if (r) {
							...
							var G, J = [],
								ca, P;
							R = T = 0;
							var U, x = Q.startContainer;
							K = D.endPath.elements[0];
							var S, v = K.getPosition(x),
								A = !!K.getCommonAncestor(x) && v != CKEDITOR.POSITION_IDENTICAL && !(v & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED),
								x = b(D.dataWrapper, D);
							for (D.editor.enterMode !== CKEDITOR.ENTER_BR && k(x, Q); y < x.length; y++) {
								v = x[y];
								if (u = v.isLineBreak) u = Q, w = q, W = F = void 0, v.hasBlockSibling ? u = 1 : (F = u.startContainer.getAscendant(l.$block, 1)) && F.is({
									div: 1,
									p: 1
								}) ? (W = F.getPosition(w), W == CKEDITOR.POSITION_IDENTICAL || W == CKEDITOR.POSITION_CONTAINS ? u = 0 : (w = u.splitElement(F), u.moveToPosition(w, CKEDITOR.POSITION_AFTER_START), u = 1)) : u = 0;
								if (u) R = 0 < y;
								else {
									u = Q.startPath();
									!v.isBlock && p(D.editor, u.block, u.blockLimit) && (P = m(D.editor)) && (P = r.createElement(P),
										P.appendBogus(), Q.insertNode(P), CKEDITOR.env.needsBrFiller && (G = P.getBogus()) && G.remove(), Q.moveToPosition(P, CKEDITOR.POSITION_BEFORE_END));
									if ((u = Q.startPath().block) && !u.equals(ca)) {
										if (G = u.getBogus()) G.remove(), J.push(u);
										ca = u
									}
									...
									if (T && v.isElement) {
										...
										if (u) w && (U = Q.splitElement(w), D.zombies.push(U), D.zombies.push(w));
										else {
											w = q.getName();
											S = !y;
											u = y == x.length - 1;
											...
											F = [];
											W = w.length;
											for (var Z = 0, Y = void 0, da = 0, fa = -1; Z < W; Z++) Y = w[Z], " " == Y ? (da || S && !Z || (F.push(new CKEDITOR.dom.text(" ")), fa = F.length), da = 1) : (F.push(Y), da = 0);
											u && fa == F.length && F.pop();
											S = F
										}
									}
									if (S) {
										for (; u = S.pop();) Q.insertNode(u);
										S = 0
									} else Q.insertNode(v.node);
									v.lastNotAllowed && y < x.length - 1 && ((U = A ? K : U) && Q.setEndAt(U, CKEDITOR.POSITION_AFTER_START), T = 0);
									Q.collapse()
								}
							}
							1 != x.length ? G = !1 : (G = x[0], G = G.isElement && "false" == G.node.getAttribute("contenteditable"));
							G && (R = !0, u = x[0].node, Q.setStartAt(u, CKEDITOR.POSITION_BEFORE_START),
								Q.setEndAt(u, CKEDITOR.POSITION_AFTER_END));
							D.dontMoveCaret = R;
							D.bogusNeededBlocks = J
						}
						G = D.range;
						var ba;
						S = D.bogusNeededBlocks;
						for (ca = G.createBookmark(); P = D.zombies.pop();) P.getParent() && (U = G.clone(), U.moveToElementEditStart(P), U.removeEmptyBlocksAtEnd());
						if (S)
							for (; P = S.pop();) CKEDITOR.env.needsBrFiller ? P.appendBogus() : P.append(G.document.createText(" "));
						for (; P = D.mergeCandidates.pop();) P.mergeSiblings();
						CKEDITOR.env.webkit && G.startPath() && (P = G.startPath(), P.block ? P.block.$.normalize() : P.blockLimit && P.blockLimit.$.normalize());
						G.moveToBookmark(ca);
						if (!D.dontMoveCaret) {
							for (P = e(G); P && a(P) && !P.is(l.$empty);) {
								if (P.isBlockBoundary()) G.moveToPosition(P, CKEDITOR.POSITION_BEFORE_END);
								else {
			...
			bogus: {
				exclude: function (a) {
					var b = a.range.getBoundaryNodes(),
						c = b.startNode,
						b = b.endNode;
					!b || !l(b) || c && c.equals(b) || a.range.setEndBefore(b)
				}
			},
			tree: {
		...
		u = function () {
			...
			return {
					...
					merge: function (a, c) {
						if (a.mergeListBookmark) {
							...
							a.mergeListItems && (g = g.contains(CKEDITOR.dtd.$listItem),
								f = f.contains(CKEDITOR.dtd.$listItem), g.equals(f) || b(f, d, e));
							d.remove();
							e.remove()
						}
					}
				...
				table: function () {
					function a(c) {
						...
						f.guard = function (a, f) {
							if (a.type == CKEDITOR.NODE_ELEMENT) {
								var B = "visited_" + (f ? "out" : "in");
								if (a.getCustomData(B)) return;
								CKEDITOR.dom.element.setMarker(t, a, B, 1)
							}
							if (f && h && a.equals(h)) g = c.clone(), g.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), e.push(g);
							else if (!f && k && a.equals(k)) g = c.clone(), g.setStartAt(k,
								CKEDITOR.POSITION_AFTER_START), e.push(g);
							else {
								if (B = !f) B = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!h || b(a, h)) && (!k || b(a, k));
								if (!B && (B = f))
									if (a.is(d)) var B = h && h.getAscendant("table", !0),
										I = k && k.getAscendant("table", !0),
										m = a.getAscendant("table", !0),
										B = B && B.contains(m) || I && I.contains(m);
									else B = void 0;
								B && (g = c.clone(), g.selectNodeContents(a), e.push(g))
							}
						};
						f.lastForward();
					...
					return {
						...
						detectRanges: function (e, g) {
							var f = c(g, e.bookmark),
								h = f.clone(),
								k, n, m = f.getCommonAncestor();
							m.is(CKEDITOR.dtd.$tableContent) && !m.is(d) && (m = m.getAscendant("table", !0));
							n = m;
							m = new CKEDITOR.dom.elementPath(f.startContainer, n);
							n = new CKEDITOR.dom.elementPath(f.endContainer, n);
							m = m.contains("table");
							n = n.contains("table");
							if (m || n) m && n && b(m, n) ? (e.tableSurroundingRange = h, h.setStartAt(m, CKEDITOR.POSITION_AFTER_END), h.setEndAt(n, CKEDITOR.POSITION_BEFORE_START),
				...
				autoParagraph: function (a, b) {
					var c = b.startPath(),
						d;
					p(a, c.block, c.blockLimit) && (d = m(a)) && (d = b.document.createElement(d), d.appendBogus(), b.insertNode(d), b.moveToPosition(d, CKEDITOR.POSITION_AFTER_START))
				}
			}
		}()
	})();
	(function () {
		...
		function d(b, c) {
			...
			if ((d = !c && 1 === b.length) && !(d = b[0].collapsed)) {
				var g = b[0];
				d = g.startContainer.getAscendant({
					td: 1,
					th: 1
				}, !0);
				...
				d && d.equals(f) && !d.findOne("td, th, tr, tbody, table") ? (g = g.cloneContents(), d = g.getFirst() ? e(g.getFirst().getText()) !== e(d.getText()) : !0) : d = !1
			}
			if (d) return !1;
			...
			if (b) {
				...
				if (!(e = !c) && (e = !c.isHidden())) {
					...
					var g = c.getRanges(),
						...
						M = 1 === f.length && f[0]._getTableElement() && f[0]._getTableElement().is("table");
					if (a(e.getSelectedElement())) e = !1;
					else {
						var n = 1 === g.length && g[0].collapsed,
							f = d(g, !!CKEDITOR.env.webkit) &&
								d(f);
						h = h && k ? h.equals(k) || k.contains(h) : !1;
						h && (n || f) ? (m && !M && e.selectRanges(g), e = !0) : e = !1
					}
					e = !e
				}
				e && (b.reset(), b = 0)
			...
			return function (d) {
				...
				if (c[e]) {
					var g = b.getSelection(),
						f = g.getRanges()[0];
					g.isCollapsed() && (f = f[38 > e ? "getPreviousEditableNode" : "getNextEditableNode"]()) && f.type == CKEDITOR.NODE_ELEMENT && "false" == f.getAttribute("contenteditable") && (g = g.getStartElement(), !g.isBlockBoundary() || "" !== (void 0 === g.$.textContent ? g.$.innerText : g.$.textContent) || a(g.getFirst()) ||
		...
		var l =
			...
			J = new RegExp(w + "( )?", "g"),
			G, q, u, K = CKEDITOR.dom.walker.invisible(1),
			E = function () {
				function a(b) {
					return function (a) {
		...
		CKEDITOR.on("instanceCreated", function (a) {
			...
			c.on("contentDom", function () {
				...
				function d(a) {
					...
					b || (b = this.getSelection(1), (c = g(b)) && !c.equals(n) && (b.selectElement(c), a.data.preventDefault()))
				}
				...
				var f = c.document,
					...
					n = c.editable(),
					t = f.getBody(),
					m = f.getDocumentElement(),
					B = n.isInline(),
					p, q;
				CKEDITOR.env.gecko && n.attachListener(n, "focus", function (a) {
					a.removeListener();
					0 !== p && (a = c.getSelection().getNative()) && a.isCollapsed && a.anchorNode == n.$ && (a = c.createRange(), a.moveToElementEditStart(n), a.select())
				}, null, null, -2);
				n.attachListener(n, CKEDITOR.env.webkit || CKEDITOR.env.gecko ? "focusin" : "focus", function () {
					if (p && (CKEDITOR.env.webkit ||
						CKEDITOR.env.gecko)) {
						p = c._.previousActive && c._.previousActive.equals(f.getActive());
						var a = null != c._.previousScrollTop && c._.previousScrollTop != n.$.scrollTop;
						CKEDITOR.env.webkit && p && a && (n.$.scrollTop = c._.previousScrollTop)
					}
					c.unlockSelection(p);
					p = 0
				}, null, null, -1);
				...
				if (CKEDITOR.env.ie || CKEDITOR.env.gecko || B) l ? n.attachListener(n, "beforedeactivate", a, null, null, -1) : n.attachListener(c, "selectionCheck", a, null, null, -1), n.attachListener(n, CKEDITOR.env.webkit || CKEDITOR.env.gecko ?
					"focusout" : "blur",
					function () {
						var a = q && (q.isFake || 2 > q.getRanges().length);
						CKEDITOR.env.gecko && !B && a || (c.lockSelection(q), p = 1)
					}, null, null, -1), n.attachListener(n, "mousedown", function () {
						p = 0
					});
							...
							m.on("mousedown", function (a) {
								function b(a) {
									...
									if (u) {
										...
										u.setEndPoint(0 > w.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart", c);
										u.select()
									}
								}
				...
				CKEDITOR.env.ie && n.attachListener(n,
					"keydown", d, c);
				n.attachListener(n, CKEDITOR.env.webkit || CKEDITOR.env.gecko ? "focusin" : "focus", function () {
					c.forceNextSelectionCheck();
					c.selectionChange(1)
				});
				if (B && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
					var y;
					n.attachListener(n, "mousedown", function () {
						y = 1
					});
				...
				} else n.attachListener(CKEDITOR.env.ie ? n : f.getDocumentElement(), "mouseup", k, c);
				CKEDITOR.env.webkit && n.attachListener(f, "keydown", function (a) {
				...
				n.attachListener(n, "keydown", F(c), null, null, -1)
			});
		...
		CKEDITOR.dom.selection = function (a) {
			...
			var d, e;
			if (a)
				if (a.getRangeAt) d = (e = a.rangeCount && a.getRangeAt(0)) &&
		...
		CKEDITOR.dom.selection.prototype = {
			...
			getRanges: function () {
				var a = l ? function () {
					...
					var b = function (b, c) {
						...
						for (var e = d.children, g, f, h = b.duplicate(), k = 0, m = e.length - 1, t = -1, l, p; k <= m;)
							if (t = Math.floor((k + m) / 2), g = e[t], h.moveToElementText(g), l = h.compareEndPoints("StartToStart",
								b), 0 < l) m = t - 1;
							else if (0 > l) k = t + 1;
							else return {
								container: d,
						...
						if (-1 == t || t == e.length - 1 && 0 > l) {
							...
							for (d = e.length; 0 < h && 0 < d;) f = e[--d], f.nodeType == CKEDITOR.NODE_TEXT && (p = f, h -= f.nodeValue.length);
							return {
								container: p,
								offset: -h
							}
						...
						for (; 0 < h;) try {
							f = g[0 < l ? "previousSibling" : "nextSibling"], f.nodeType == CKEDITOR.NODE_TEXT && (h -= f.nodeValue.length, p = f), g = f
						} catch (q) {
							return {
								container: d,
								offset: a(g)
					...
					return function () {
						...
						if (d == CKEDITOR.SELECTION_ELEMENT) {
							for (var d = [], e = 0; e < c.length; e++) {
								...
								a.setEnd(new CKEDITOR.dom.node(f),
									h + 1);
								d.push(a)
							}
							return d
				...
				var b = this,
					c = CKEDITOR.tools.tryThese(function () {
						...
						for (var a = b.getRanges()[0].clone(), c, d, e = 2; e && !((c = a.getEnclosedNode()) &&
							c.type == CKEDITOR.NODE_ELEMENT && C[c.getName()] && (d = c)); e--) a.shrink(CKEDITOR.SHRINK_ELEMENT);
						return d && d.$
					});
			...
			getSelectedText: function () {
				...
				var b = this.getNative(),
					b = l ? "Control" == b.type ? "" : b.createRange().text : b.toString();
			...
			selectRanges: function (a) {
				...
				this.reset();
				if (c)
					for (var c = this.root, e, h = 0; h < a.length; ++h) e = a[h], e.endContainer.equals(c) && (e.endOffset = Math.min(e.endOffset, c.getChildCount()));
				if (a.length)
					if (this.isLocked) {
						...
						a: {
							var p, M;
							if (1 == a.length && !(M = a[0]).collapsed && (r = M.getEnclosedNode()) && r.type == CKEDITOR.NODE_ELEMENT && (M = M.clone(), M.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (p = M.getEnclosedNode()) && p.type == CKEDITOR.NODE_ELEMENT &&
								(r = p), "false" == r.getAttribute("contenteditable"))) break a; r = void 0
						}
						if (r) this.fake(r);
						else if (b && b.plugins.tableselection && b.plugins.tableselection.isSupportedEnvironment(b) && d(a) && !G && !a[0]._getTableElement({
							table: 1
							...
							if (l) {
								...
								a = b.collapsed;
								var n, D, q;
								if ((c = b.getEnclosedNode()) &&
									c.type == CKEDITOR.NODE_ELEMENT && c.getName() in C && (!c.is("a") || !c.getText())) try {
								...
								for (q = 0; q < a.length; q++) {
									if (q < a.length - 1 && (n = a[q], D = a[q + 1], r = n.clone(), r.setStart(n.endContainer, n.endOffset), r.setEnd(D.startContainer, D.startOffset), !r.collapsed && (r.shrink(CKEDITOR.NODE_ELEMENT, !0), b = r.getCommonAncestor(), r = r.getEnclosedNode(), b.isReadOnly() || r && r.isReadOnly()))) {
										D.setStart(n.startContainer, n.startOffset);
										a.splice(q--,
											1);
										continue
									}
									...
									b.collapsed && CKEDITOR.env.webkit && m(b) && (r = g(this.root), b.insertNode(r), (n = r.getNext()) && !r.getPrevious() && n.type == CKEDITOR.NODE_ELEMENT && "br" == n.getName() ? (x(this.root), b.moveToPosition(n, CKEDITOR.POSITION_BEFORE_START)) : b.moveToPosition(r, CKEDITOR.POSITION_AFTER_END));
	...
	(function () {
		...
		function b(c) {
			...
			if (c.collapsed) e = L(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END);
				...
				null ==
					l && (l = c.root.getCustomData("cke_includeReadonly"));
				...
				for (x.getPosition(v) == CKEDITOR.POSITION_FOLLOWING && (x = 0); x;) {
					m = !1;
					if (x.equals(v)) x = null, m = !0;
					else {
						var w = x.type == CKEDITOR.NODE_ELEMENT ? x.getName() : null,
							y = w && "false" == x.getAttribute("contentEditable"),
							A = w &&
								-1 !== CKEDITOR.tools.array.indexOf(CKEDITOR.style.unstylableElements, w),
							A = w && (x.getAttribute("data-nostyle") || A);
						if (w && x.data("cke-bookmark") || x.type === CKEDITOR.NODE_COMMENT) {
							x = x.getNextSourceNode(!0);
							continue
						}
						if (y && l && CKEDITOR.dtd.$block[w])
							for (var C = x, B = f(C), E = void 0, G = B.length, H = 0, C = G && new CKEDITOR.dom.range(C.getDocument()); H < G; ++H) {
								var E = B[H],
									J = CKEDITOR.filter.instances[E.data("cke-filter")];
								if (J ? J.check(this) : 1) C.selectNodeContents(E), b.call(this, C)
							}
						B = w ? !p[w] || A ? 0 : y && !l ? 0 : d(x, v, h, N) : 1;
						if (B)
							if (E =
								x.getParent(), B = h, G = g, H = k, !E || !(E.getDtd() || CKEDITOR.dtd.span)[G] && !H || B.parentRule && !B.parentRule(E)) m = !0;
							else {
								if (u || w && CKEDITOR.dtd.$removeEmpty[w] && (x.getPosition(v) | N) != N || (u = c.clone(), u.setStartBefore(x)), w = x.type, w == CKEDITOR.NODE_TEXT || y || w == CKEDITOR.NODE_ELEMENT && !x.getChildCount()) {
									for (var w = x, K;
										(m = !w.getNext(z)) && (K = w.getParent(), p[K.getName()]) && d(K, t, h, O);) w = K;
									u.setEndAfter(w)
								}
							}
						else m = !0;
						x = x.getNextSourceNode(A || y)
					}
					if (m && u && !u.collapsed) {
						for (var m = L(this, e), y = m.hasAttributes(), A = u.getCommonAncestor(),
							w = {}, B = {}, E = {}, G = {}, U, S, Y; m && A;) {
							if (A.getName() == g) {
								for (U in h.attributes) !G[U] && (Y = A.getAttribute(S)) && (m.getAttribute(U) == Y ? B[U] = 1 : G[U] = 1);
								for (S in h.styles) !E[S] && (Y = A.getStyle(S)) && (m.getStyle(S) == Y ? w[S] = 1 : E[S] = 1)
							}
							A = A.getParent()
						}
						for (U in B) m.removeAttribute(U);
						for (S in w) m.removeStyle(S);
						y && !m.hasAttributes() && (m = null);
						m ? (u.extractContents().appendTo(m), u.insertNode(m), F.call(this, m), m.mergeSiblings(), CKEDITOR.env.ie || m.$.normalize()) : (m = new CKEDITOR.dom.element("span"), u.extractContents().appendTo(m),
							u.insertNode(m), F.call(this, m), m.remove(!0));
						u = null
					}
				}
				c.moveToBookmark(q);
		...
		function c(a) {
			...
			if (a.collapsed) {
				for (var g = new CKEDITOR.dom.elementPath(d.getParent(), a.root), f, h = 0, k; h < g.elements.length && (k = g.elements[h]) && k != g.block && k != g.blockLimit; h++)
					if (this.checkElementRemovable(k)) {
						var m;
						!e && a.collapsed && (a.checkBoundaryOfElement(k, CKEDITOR.END) || (m = a.checkBoundaryOfElement(k, CKEDITOR.START))) ? (f = k, f.match = m ? "start" : "end") :
				...
				var l = c.endNode,
					p = this;
				b();
				for (g = d; !g.equals(l);) f = g.getNextSourceNode(), g.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(g) && (g.getName() == this.element ? A.call(this, g) : v(g, G(this)[g.getName()]), f.type == CKEDITOR.NODE_ELEMENT && f.contains(d) &&
					(b(), f = d.getNext())), g = f
			}
			a.moveToBookmark(c);
		...
		function h(a) {
			...
			for (var d, e = a.document, g; d = c.getNextParagraph();) !d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (g = L(this, e, d), m(d, g));
			a.moveToBookmark(b)
		}
		...
		function p(a) {
			...
			for (var d, e; d = c.getNextParagraph();) this.checkElementRemovable(d) && (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(e), m(d, e)) : A.call(this, d));
			a.moveToBookmark(b)
		}
		...
		function A(a, b) {
			var c = this._.definition,
				...
				f;
			for (f in d)
				if ("class" != f && !this._.definition.fullMatch || a.getAttribute(f) == q(f, d[f])) b && "data-" == f.slice(0, 5) || (g = a.hasAttribute(f), a.removeAttribute(f));
			for (var h in c) this._.definition.fullMatch && a.getStyle(h) != q(h, c[h], !0) || (g = g || !!a.getStyle(h), a.removeStyle(h));
			v(a, e, E[a.getName()]);
		...
		function F(a) {
			for (var b = G(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;) d = c.getItem(e), d.isReadOnly() || A.call(this, d, !0);
			for (var g in b)
				if (g != this.element)
		...
		function K(a, b, c) {
			...
			for (var e, g = d.createIterator(); e = g.getNextRange();) b.call(this, e, c);
			a.selectRanges(d)
		}
		var E = {
			address: 1,
		...
		CKEDITOR.style = function (a, b) {
			...
			c = this.element = a.element ? "string" == typeof a.element ? a.element.toLowerCase() :
				a.element : "*";
			this.type = a.type || (E[c] ? CKEDITOR.STYLE_BLOCK : C[c] ? CKEDITOR.STYLE_OBJECT : CKEDITOR.STYLE_INLINE);
			...
			checkElementMatch: function (a, b) {
				...
				if ("string" == typeof this.element ?
					...
					if (c._length) {
						for (var h in c)
							if ("_length" != h)
								if (d = a.getAttribute(h) || "", "style" == h ? u(c[h], d) : c[h] == d) {
									if (!b) return !0
								} else if (b) return !1;
						if (b) return !0
					} else return !0
	...
	(function () {
		...
		CKEDITOR.dom.selection.prototype.optimizeInElementEnds = function () {
			var b = this.getRanges()[0],
				f = this.root.editor,
				e;
			if (this.root.editor._.shiftPressed || this.isFake || b.isCollapsed || b.startContainer.equals(b.endContainer) || (b.endContainer.is ? b.endContainer.is("li") : b.endContainer.getParent().is && b.endContainer.getParent().is("li"))) e = !1;
			else if (0 === b.endOffset) e = !0;
			else {
				e = b.startContainer.type === CKEDITOR.NODE_TEXT;
				var k = b.endContainer.type === CKEDITOR.NODE_TEXT,
					h = e ? b.startContainer.getLength() :
			...
			}), d = !1, a(f, b, e), b.select(), d = !0)
		}
	})();
	(function () {
		function a(a, c) {
			if (b(a)) a = Math.round(c * (parseFloat(a) / 100));
			else if ("string" === typeof a && a.match(/^\d+$/gm) || "string" === typeof a && a.match(/^\d+(?:deg)?$/gm)) a = parseInt(a, 10);
			return a
		}
			...
			CKEDITOR.tools.createClass({
				...
				proto: {
					...
					getHexWithAlpha: function () {
						...
						return this._.formatHexString(this._.red,
					...
					getHsl: function () {
						...
						if (!this._.isValidColor) return this._.defaultValue;
						this._.type ===
							CKEDITOR.tools.color.TYPE_HSL && a ? a = [this._.hue, this._.saturation, this._.lightness] : (a = this._.blendAlphaColor(this._.red, this._.green, this._.blue, this._.alpha), a = this._.rgbToHsl(a[0], a[1], a[2]));
						return this._.formatHslString("hsl", a[0], a[1], a[2])
					},
					getHsla: function () {
						var a;
						if (!this._.isValidColor) return this._.defaultValue;
						a = this._.type === CKEDITOR.tools.color.TYPE_HSL ? [this._.hue, this._.saturation, this._.lightness] : this._.rgbToHsl(this._.red, this._.green, this._.blue);
						return this._.formatHslString("hsla",
				...
				_: {
					...
					blendAlphaColor: function (a, b, c, d) {
						return CKEDITOR.tools.array.map([a, b, c], function (a) {
							return Math.round(CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE - d * (CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE - a))
						})
					},
					...
					parseInput: function (a) {
						if ("string" !== typeof a) this._.isValidColor = !1;
							...
							(a = b || c || a) ? (this._.type = a.type, this._.red = a.red, this._.green =
					...
					extractColorChannelsFromHex: function (a) {
						...
						a.match(CKEDITOR.tools.color.hex4CharsRegExp) && (a = this._.hex4ToHex8(a));
					...
					extractColorChannelsFromRgba: function (b) {
						...
						if (!c ||
							3 > c.length || 4 < c.length) return null;
						var f = 4 === c.length;
						b = a(c[0], CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE);
						var p = a(c[1], CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE),
							m = a(c[2], CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE),
							g = 1;
						...
						return this._.areColorChannelsValid(b, p, m, g) ? c : null
					},
					extractColorChannelsFromHsla: function (b) {
						...
						var f = 4 === c.length,
							p = a(c[0], CKEDITOR.tools.color.MAX_HUE_CHANNEL_VALUE),
							m = d(c[1], CKEDITOR.tools.color.MAX_SATURATION_LIGHTNESS_CHANNEL_VALUE),
							g = d(c[2], CKEDITOR.tools.color.MAX_SATURATION_LIGHTNESS_CHANNEL_VALUE),
							x = 1;
						b = this._.hslToRgb(p, m, g);
						...
						c = {
							...
							alpha: b[3],
							hue: p,
							saturation: Math.round(100 * m),
							lightness: Math.round(100 * g)
						};
						return this._.areColorChannelsValid(b[0],
							b[1], b[2], b[3]) ? c : null
					},
					...
					hex4ToHex8: function (a) {
						return this._.hex3ToHex6(a.substr(0, 4)) + CKEDITOR.tools.repeat(a[4], 2)
					},
					extractColorChannelsByPattern: function (a, b) {
						...
						var d = -1 === c[1].indexOf(",") ? /\s/ : ",",
							d = c[1].split(d),
							d = CKEDITOR.tools.array.reduce(d, function (a, b) {
								var c = CKEDITOR.tools.trim(b);
								return 0 === c.length ? a : a.concat([c])
							}, []);
						c[2] && (c = CKEDITOR.tools.trim(c[2].replace(/[\/,]/, "")), d.push(c));
						return d
					},
					areColorChannelsValid: function (a, b, d, f) {
						return c(a, 0, CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE) && c(b, 0, CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE) && c(d, 0, CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE) && c(f, 0, CKEDITOR.tools.color.MAX_ALPHA_CHANNEL_VALUE)
					},
					hslToRgb: function (a, b, c) {
						var d = function (d) {
							...
							g = Math.max(-1, g);
							return Math.round((c - d * g) * CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE)
						};
						return [d(0), d(8), d(4)]
					},
		...
		CKEDITOR.dom.elementPath = function (b, f) {
			...
			do
				if (p.type == CKEDITOR.NODE_ELEMENT) {
					...
					if (p.equals(f)) break;
					if (!k && (m = p.getName(),
						"true" == p.getAttribute("contenteditable") ? k = p : !e && d[m] && (e = p), a[m])) {
						if (m = !e && "div" == m) {
							a: {
								m = p.getChildren();
								for (var g = 0, x = m.count(); g < x; g++) {
									var y = m.getItem(g);
	...
	CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
		...
		split: function (a) {
			...
			d.childNodes.length ==
				b && (a >= c ? (e = f.createText(""), e.insertAfter(this)) : (a = f.createText(""), a.insertAfter(e), a.remove()));
			return e
		},
	...
	(function () {
		function a(a, c, d) {
			var e = a.serializable,
				...
				p = e ? c.document.getById(a.startNode) : a.startNode;
		...
		var d = {
						...
						if (h && 1 < a.length) {
							...
							if (k)
								for (var m = 0; a[e + m + 1];) {
									var g = h.document;
									k = 0;
									p = g.getById(d[m].endNode);
									for (g = g.getById(d[m + 1].startNode); ;) {
										p =
			...
			createBookmarks: function (b) {
				for (var c = [], d, e = 0; e < this.length; e++) {
					...
					for (var k = e + 1; k < this.length; k++) this[k] = a(d, this[k]), this[k] = a(d, this[k], !0)
				}
				return c
			},
			createBookmarks2: function (a) {
	...
	*/
	...
	CKEDITOR.plugins.add("dialogui", {
		onLoad: function () {
			...
			CKEDITOR.tools.extend(CKEDITOR.ui.dialog, {
				labeledElement: function (b, a, d, e) {
					if (!(4 > arguments.length)) {
						...
						CKEDITOR.ui.dialog.uiElement.call(this, b, a, d, "div", null, f, function () {
							var d = [],
								g = a.required ? " cke_required" : "";
							"horizontal" != a.labelLayout ? d.push('\x3clabel class\x3d"cke_dialog_ui_labeled_label' + g + '" ', ' id\x3d"' + c.labelId + '"', c.inputId ? ' for\x3d"' + c.inputId + '"' : "", (a.labelStyle ? ' style\x3d"' + a.labelStyle + '"' : "") + "\x3e", a.required ? a.label + '\x3cspan class\x3d"cke_dialog_ui_labeled_required" aria-hidden\x3d"true"\x3e*\x3c/span\x3e' :
					...
					if (!(3 > arguments.length)) {
						...
						CKEDITOR.ui.dialog.labeledElement.call(this, b, a, d, function () {
							...
							var a = ['\x3cdiv class\x3d"cke_dialog_ui_input_textarea" role\x3d"presentation"\x3e\x3ctextarea id\x3d"', c, '" '],
								b;
							for (b in f) a.push(b + '\x3d"' + CKEDITOR.tools.htmlEncode(f[b]) + '" ');
				...
				checkbox: function (b, a, d) {
					if (!(3 > arguments.length)) {
						...
						CKEDITOR.ui.dialog.uiElement.call(this, b, a, d, "span", null, null, function () {
							...
							d.push(' \x3clabel id\x3d"', h, '" for\x3d"', g.id, '"' + (a.labelStyle ? ' style\x3d"' + a.labelStyle + '"' : "") + "\x3e", CKEDITOR.tools.htmlEncode(a.label), "\x3c/label\x3e");
							return d.join("")
						})
					}
				},
					...
					if (!(3 > arguments.length)) {
						...
						CKEDITOR.ui.dialog.labeledElement.call(this, b, a, d, function () {
							for (var d = [], h = [], g = (a.id ? a.id : CKEDITOR.tools.getNextId()) + "_radio", n = 0; n < a.items.length; n++) {
								...
								m = new CKEDITOR.ui.dialog.uiElement(b, p, u, "input", null, r);
								m.on("focus", function () {
									c.click()
								});
								e.push(m);
								u.push(" ");
								new CKEDITOR.ui.dialog.uiElement(b, k, u, "label", null, {
									id: q,
									"for": r.id
								}, l[0]);
								d.push(u.join(""))
				...
				select: function (b, a, d) {
					if (!(3 > arguments.length)) {
						...
						CKEDITOR.ui.dialog.labeledElement.call(this, b, a, d, function () {
							...
							t(c);
							for (var n = 0, l; n < a.items.length && (l = a.items[n]); n++) h.push('\x3coption value\x3d"', CKEDITOR.tools.htmlEncode(void 0 !== l[1] ? l[1] : l[0]).replace(/"/g, "\x26quot;"), '" /\x3e ', CKEDITOR.tools.htmlEncode(l[0]));
					...
					if (!(3 > arguments.length)) {
						...
						CKEDITOR.ui.dialog.labeledElement.call(this,
							...
							function () {
								...
								var b = ['\x3ciframe frameborder\x3d"0" allowtransparency\x3d"0" class\x3d"cke_dialog_ui_input_file" role\x3d"presentation" id\x3d"', e.frameId, '" title\x3d"', a.label, '" src\x3d"javascript:void('];
				...
				fieldset: function (b, a, d, e, c) {
					...
					CKEDITOR.ui.dialog.uiElement.call(this, b, c, e, "fieldset", null, null, function () {
						var a = [];
						f && a.push("\x3clegend" + (c.labelStyle ? ' style\x3d"' + c.labelStyle + '"' : "") + "\x3e" + f + "\x3c/legend\x3e");
			...
			CKEDITOR.ui.dialog.radio.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.uiElement, {
				...
				setValue: function (b, a) {
					for (var d = this._.children,
						e, c = 0; c < d.length && (e = d[c]); c++) e.getElement().$.checked = e.getValue() == b;
					!a && this.fire("change", {
						value: b
					});
					return this
			...
			CKEDITOR.ui.dialog.file.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.labeledElement, q, {
				getInputElement: function () {
					var b =
						CKEDITOR.document.getById(this._.frameId).getFrameDocument();
				...
				registerEvents: function (b) {
					var a = /^on([A-Z]\w+)/,
						...
						c;
					for (c in b)
						if (d = c.match(a)) this.eventProcessors[c] ? this.eventProcessors[c].call(this,
							this._.dialog, b[c]) : e(this, this._.dialog, d[1].toLowerCase(), b[c]);
					return this
				},
				reset: function () {
					function b() {
						...
						d.$.write(['\x3chtml dir\x3d"' + g + '" lang\x3d"' + n + '"\x3e\x3chead\x3e\x3ctitle\x3e\x3c/title\x3e\x3c/head\x3e\x3cbody style\x3d"margin: 0; overflow: hidden; background: transparent;"\x3e', '\x3cform enctype\x3d"multipart/form-data" method\x3d"POST" dir\x3d"' + g + '" lang\x3d"' + n + '" action\x3d"', CKEDITOR.tools.htmlEncode(e.action),
						...
						"window.onbeforeunload \x3d function() {window.parent.CKEDITOR.tools.callFunction(" + h + ")}", "\x3c/script\x3e"
						].join(""));
						d.$.close();
	...
	(function () {
		...
		function ca(a) {
			function b(b) {
				...
				d.x += r;
				d.y += n;
				q = d.x + k[3] < g ? -k[3] : d.x - k[1] > h.width - c.width - g ? h.width - c.width + ("rtl" == f.lang.dir ? 0 : k[1]) : d.x;
				c = d.y + k[0] < g ? -k[0] : d.y - k[2] > h.height - c.height - g ? h.height - c.height + k[2] : d.y;
				q = Math.floor(q);
				c = Math.floor(c);
				a.move(q, c, 1);
			...
			a.parts.title.on("mousedown", function (f) {
				...
				d = a.getPosition();
				CKEDITOR.env.ie6Compat && (g = u.getChild(0).getFrameDocument(), g.on("mousemove",
					b), g.on("mouseup", c));
		...
		function da(a) {
			function b(b) {
				...
				A = Math.floor(A);
				w = Math.floor(w);
				if (d == CKEDITOR.DIALOG_RESIZE_WIDTH || d == CKEDITOR.DIALOG_RESIZE_BOTH) m =
					Math.max(e.minWidth || 0, w - g);
				if (d == CKEDITOR.DIALOG_RESIZE_HEIGHT || d == CKEDITOR.DIALOG_RESIZE_BOTH) q = Math.max(e.minHeight || 0, A - k);
				a.resize(m, q);
			...
			if (d != CKEDITOR.DIALOG_RESIZE_NONE) {
				var f = a.getParentEditor(),
					g, k, p, l, h, q, m = CKEDITOR.tools.addFunction(function (d) {
						function e(a) {
							return a.isVisible()
						}
						h = a.getSize();
		...
		CKEDITOR.dialog = function (a, b) {
			...
			function d(b) {
				if (n == CKEDITOR.dialog._.currentTop) {
					...
					if (9 == c || c == CKEDITOR.SHIFT + 9) e(c == CKEDITOR.SHIFT + 9 ? -1 : 1), q = 1;
						...
						if (13 == c) c = b.data.getTarget(), c.is("a", "button", "select", "textarea") || c.is("input") && "button" == c.$.type || ((c = this.getButton("ok")) && CKEDITOR.tools.setTimeout(c.click, 0, c), q = 1), m = 1;
			...
			var g = CKEDITOR.dialog._.dialogDefinitions[b],
				...
				h = {},
				q, m;
			("OS" == p && CKEDITOR.env.mac || "rtl" == p && "ltr" == l || "ltr" == p && "rtl" == l) && k.buttons.reverse();
			...
			for (l = 0; l < g.contents.length; l++)(h = g.contents[l]) && this.addPage(h);
		...
		CKEDITOR.dialog.prototype = {
			...
			move: function (a, b, c) {
				...
				this._.position && this._.position.x == a && this._.position.y == b ? (a = Math.floor(p * k.width), b = Math.floor(f * k.height)) : O(this, a, b);
				this._.position = {
					x: a,
					y: b
				};
					...
					if (b.contents[d]) {
						...
						if (e) {
							for (var g in this._.contents[a.id]) {
								...
								"hbox" != k.type && "vbox" != k.type && k.getInputElement() && (k.requiredContent && !this._.editor.activeFilter.check(k.requiredContent) ? k.disable() :
									(k.enable(), f++))
				...
				if (this.parts.dialog.isVisible()) {
					...
					if (this._.parentDialog) {
						var b = this._.parentDialog.getElement().getFirst(),
							c = parseInt(b.$.style.zIndex, 10) + Math.floor(this._.editor.config.baseFloatZIndex / 2);
			...
			setState: function (a) {
				if (this.state != a) {
					...
					} else a == CKEDITOR.DIALOG_STATE_IDLE && (this.parts.spinner && this.parts.spinner.hide(), this.getButton("ok") && this.getButton("ok").enable());
					this.fire("state", a)
				}
			},
			getModel: function (a) {
				...
				uiElement: function (a, b, c, e, d, f, g) {
					if (!(4 > arguments.length)) {
						var k = (e.call ? e(b) : e) || "div",
							...
							m = this.domId = h.id || CKEDITOR.tools.getNextId() + "_uiElement";
						...
						for (var n = h["class"] && h["class"].split ? h["class"].split(" ") : [], m = 0; m < n.length; m++) n[m] && (r[n[m]] = 1);
						n = [];
						for (m in r) n.push(m);
						h["class"] = n.join(" ");
						b.title && (h.title = b.title);
						r = (b.style || "").split(";");
						b.align && (n = b.align, l["margin-left"] = "left" == n ? 0 : "auto", l["margin-right"] = "right" == n ? 0 : "auto");
		...
		(function () {
			var a = {
				build: function (a,
					c, e) {
					for (var d = c.children, f, g = [], k = [], p = 0; p < d.length && (f = d[p]); p++) {
						var l = [];
						g.push(l);
	...
	CKEDITOR.plugins.add("basicstyles", {
		init: function (a) {
			var f = 0,
				d = function (h, d, c, b) {
					if (b) {
						...
						a.addCommand(c, new CKEDITOR.styleCommand(b, {
							contentForms: g
						}));
						a.ui.addButton && a.ui.addButton(h, {
							isToggle: !0,
							label: d,
							command: c,
			...
			d("Subscript", b.subscript,
				"subscript", c.coreStyles_subscript);
		...
		afterInit: function (a) {
			if (a.config.coreStyles_toggleSubSup) {
				...
				if (f && d) a.on("afterCommandExec", function (e) {
					e = e.data.name;
	...
	(function () {
		function q(a, f, e, b) {
			if (!a.isReadOnly() && !a.equals(e.editable())) {
				...
				(b ? a.getComputedStyle("direction") : a.getStyle("direction") || a.hasAttribute("dir")) != f && (a.removeStyle("direction"), b ? (a.removeAttribute("dir"), f != a.getComputedStyle("direction") && a.setAttribute("dir",
		...
		function v(a, f, e) {
			...
			a = a.clone();
			a.enlarge(e == CKEDITOR.ENTER_BR ? CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS : CKEDITOR.ENLARGE_BLOCK_CONTENTS);
		...
		function p(a) {
			return {
				...
				refresh: function (a, e) {
					...
					c && (b = b ? c.getComputedStyle("direction") : c.getStyle("direction") ||
						c.getAttribute("dir"), a.getCommand("bidirtl").setState("rtl" == b ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF), a.getCommand("bidiltr").setState("ltr" == b ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF));
					...
					if (c && c.length) {
						for (var h = {}, d = e.createBookmarks(), c = c.createIterator(), g, l = 0; g = c.getNextRange(1);) {
							...
							m.evaluator = function (a) {
								...
								return !!(d && a.getPosition(n) & CKEDITOR.POSITION_FOLLOWING && (a.getPosition(p) & CKEDITOR.POSITION_PRECEDING +
		...
		function w(a) {
			...
			return function (c, h) {
				if (!this.isReadOnly()) {
					var d;
					if (d = c == (f || e ? "dir" : "direction") || "style" ==
						c && (e || b.test(h))) {
						a: {
							d = this;
					...
					if (d && (d = this.getDirection(1), g = a.apply(this, arguments), d != this.getDirection(1))) return this.getDocument().fire("dirChanged", this), g
				}
	...
	(function () {
		...
		CKEDITOR.ui.button.prototype = {
			render: function (a, b) {
				...
				}, this), a.on("activeFilterChange", c, this), a.on("mode", c, this), !this.readOnly && a.on("readOnly", c, this)) : d && (d = a.getCommand(d)) &&
				(d.on("state", function () {
				...
				d ? (m = a.getCommandKeystroke(d)) && (k = CKEDITOR.tools.keystrokeToString(a.lang.common.keyboard,
					m)) : g += "off";
			...
			setState: function (a) {
				...
				return b ? (b.setState(a, "cke_button"), b.setAttribute("aria-disabled", a == CKEDITOR.TRISTATE_DISABLED), this.isToggle && !this.hasArrow && b.setAttribute("aria-pressed", a === CKEDITOR.TRISTATE_ON), !0) : !1
			},
			getState: function () {
				return this._.state
			},
	...
	(function () {
		function D(b) {
			function d() {
				for (var a = f(), e = CKEDITOR.tools.clone(b.config.toolbarGroups) || v(b), n = 0; n < e.length; n++) {
					var g = e[n];
					if ("/" != g) {
						...
						var l, d = g.groups;
						if (d)
							for (var h = 0; h < d.length; h++) l = d[h], (l = a[l]) && c(g, l);
						(l = a[g.name]) && c(g, l)
					}
				}
				return e
			...
			function f() {
				var a = {},
					c, e, g;
				for (c in b.ui.items) e = b.ui.items[c], g = e.toolbar || "others", g = g.split(","), e = g[0], g = parseInt(g[1] || -1, 10), a[e] || (a[e] = []), a[e].push({
					name: c,
					order: g
				});
				for (e in a) a[e] = a[e].sort(function (a,
					b) {
			...
			function c(c, e) {
				if (e.length) {
					...
					for (var d; d = e.shift();) d = "string" == typeof d ? d : d.name, a && -1 != CKEDITOR.tools.indexOf(a, d) || (d = b.ui.create(d)) && b.addFeature(d) && c.items.push(d)
				}
			}
			...
			function h(a) {
				var b = [],
					e, d, h;
				for (e = 0; e < a.length; ++e) d = a[e], h = {}, "/" == d ? b.push(d) : CKEDITOR.tools.isArray(d) ? (c(h, CKEDITOR.tools.clone(d)), b.push(h)) : d.items && (c(h, CKEDITOR.tools.clone(d.items)),
					h.name = d.name, b.push(h));
				return b
			}
			var a = function (a) {
		...
		function v(b) {
			return b._.toolbarGroups || (b._.toolbarGroups = [{
				name: "document",
		...
		var E = {
			...
			readOnly: 1,
			exec: function (b) {
				b.toolbox && (CKEDITOR.env.ie || CKEDITOR.env.air ? setTimeout(function () {
					b.toolbox.focus()
				}, 100) : b.toolbox.focus())
			}
		};
					...
					switch (h) {
						...
						case CKEDITOR.SHIFT + 9:
							for (; !a || !a.items.length;)
								if (a = 9 == h ? (a ? a.next : c.toolbar.next) || b.toolbox.toolbars[0] : (a ? a.previous : c.toolbar.previous) || b.toolbox.toolbars[b.toolbox.toolbars.length - 1], a.items.length)
									for (c = a.items[d ? a.items.length - 1 : 0]; c && !c.focus;)(c = d ? c.previous : c.next) || (a = 0);
							c && c.focus();
							return !1;
						case q:
							a = c;
							do a = a.next, !a && k && (a = c.toolbar.items[0]); while (a && !a.focus);
							a ? a.focus() : f(c, 9);
							return !1;
						case 40:
						...
						case 38:
							a = c;
							do a = a.previous, !a && k && (a = c.toolbar.items[c.toolbar.items.length - 1]); while (a && !a.focus);
				...
				b.on("uiSpace", function (c) {
					if (c.data.space ==
						...
						var d = CKEDITOR.tools.getNextId(),
							a = ['\x3cspan id\x3d"', d, '" class\x3d"cke_voice_label"\x3e', b.lang.toolbar.toolbars, "\x3c/span\x3e", '\x3cspan id\x3d"' + b.ui.spaceId("toolbox") + '" class\x3d"cke_toolbox" role\x3d"group" aria-labelledby\x3d"', d, '" onmousedown\x3d"return false;"\x3e'],
							d = !1 !== b.config.toolbarStartupExpanded,
							e, k;
						b.config.toolbarCanCollapse && b.elementMode != CKEDITOR.ELEMENT_MODE_INLINE && a.push('\x3cspan class\x3d"cke_toolbox_main"' +
							(d ? "\x3e" : ' style\x3d"display:none"\x3e'));
						for (var q = b.toolbox.toolbars, n = D(b), g = n.length, l = 0; l < g; l++) {
							var r, m = 0,
								w, p = n[l],
								v = "/" !== p && ("/" === n[l + 1] || l == g - 1),
								x;
							if (p)
								if (e && (a.push("\x3c/span\x3e"), k = e = 0), "/" === p) a.push('\x3cspan class\x3d"cke_toolbar_break"\x3e\x3c/span\x3e');
								else {
									x = p.items || p;
									for (var y = 0; y < x.length; y++) {
										...
										if (t) {
											...
											if (t.type == CKEDITOR.UI_SEPARATOR) k = e &&
												t;
											else {
												A = !1 !== t.canGroup;
												if (!m) {
													...
													w = p.name && (b.lang.toolbar.toolbarGroups[p.name] || p.name);
													a.push('\x3cspan id\x3d"', r, '" class\x3d"cke_toolbar' + (v ? ' cke_toolbar_last"' : '"'), w ? ' aria-labelledby\x3d"' + r + '_label"' : "", ' role\x3d"toolbar"\x3e');
													w && a.push('\x3cspan id\x3d"', r, '_label" class\x3d"cke_voice_label"\x3e', w, "\x3c/span\x3e");
													a.push('\x3cspan class\x3d"cke_toolbar_start"\x3e\x3c/span\x3e');
													var u = q.push(m) - 1;
													0 < u && (m.previous = q[u - 1], m.previous.next = m)
												}
												A ?
													e || (a.push('\x3cspan class\x3d"cke_toolgroup" role\x3d"presentation"\x3e'), e = 1) : e && (a.push("\x3c/span\x3e"), e = 0);
												k && (B(k), k = 0);
												B(t)
											}
										}
									...
									m && a.push('\x3cspan class\x3d"cke_toolbar_end"\x3e\x3c/span\x3e\x3c/span\x3e')
								}
						}
						...
						if (b.config.toolbarCanCollapse && b.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
							...
							b.addCommand("toolbarCollapse", {
								...
								exec: function (a) {
									...
									f ? (c.show(), b.removeClass("cke_toolbox_collapser_min"), b.setAttribute("title", a.lang.toolbar.toolbarCollapse)) : (c.hide(), b.addClass("cke_toolbox_collapser_min"), b.setAttribute("title", a.lang.toolbar.toolbarExpand));
							...
							a.push('\x3ca title\x3d"' + (d ? b.lang.toolbar.toolbarCollapse : b.lang.toolbar.toolbarExpand) + '" id\x3d"' + b.ui.spaceId("toolbar_collapser") + '" tabIndex\x3d"-1" class\x3d"cke_toolbox_collapser');
				...
				b.on("destroy", function () {
					if (this.toolbox) {
						...
						for (b = this.toolbox.toolbars; d < b.length; d++)
							for (e = b[d].items, a = 0; a < e.length; a++) f = e[a], f.clickFn && CKEDITOR.tools.removeFunction(f.clickFn), f.keyDownFn && CKEDITOR.tools.removeFunction(f.keyDownFn)
					}
				});
				b.on("uiReady", function () {
					var c = b.ui.space("toolbox");
					c && b.focusManager.add(c,
						1)
				});
		...
		CKEDITOR.ui.prototype.addToolbarGroup = function (b, d, f) {
			...
			h ? c.splice(0, 0, b) : "number" == typeof d ? c.splice(d + 1, 0, a) : c.push(b)
		}
	})();
	...
	(function () {
		...
		function y(a) {
			function b() {
				...
				"beforepaste" == n.mainPasteEvent && (b.on("paste", function (a) {
					w || (g(), a.data.preventDefault(), m(a), e("paste"))
				}), b.on("contextmenu", f, null, null, 0), b.on("beforepaste", function (a) {
				...
				return {
					...
					exec: function (a, b) {
						function c(b, m) {
							...
							b ? (b.method = "paste", b.dataTransfer || (b.dataTransfer = n.initPasteDataTransfer()), t(a, b, m)) : d && !a._.forcePasteDialog && a.showNotification(p, "info", a.config.clipboard_notificationDuration);
			...
			function l() {
				if (CKEDITOR.env.ie && !CKEDITOR.env.quirks) {
					var b = a.getSelection(),
						c, h, d;
					b.getType() == CKEDITOR.SELECTION_ELEMENT && (c = b.getSelectedElement()) && (h = b.getRanges()[0], d = a.document.createText(""), d.insertBefore(c), h.setStartBefore(d), h.setEndAfter(c), b.selectRanges([h]), setTimeout(function () {
			...
			function q(b, c) {
				...
				if (!h.getById("cke_pastebin")) {
					...
					var k = new CKEDITOR.dom.element(!CKEDITOR.env.webkit && !d.is("body") || CKEDITOR.env.ie ? "div" : "body", h);
					k.setAttributes({
						id: "cke_pastebin",
						"data-cke-temp": "1"
					});
					var f = 0,
						h = h.getWindow();
					CKEDITOR.env.webkit ? (d.append(k), k.addClass("cke_editable"), d.is("body") || (f = "static" != d.getComputedStyle("position") ?
						d : CKEDITOR.dom.element.get(d.$.offsetParent), f = f.getDocumentPosition().y)) : d.getAscendant(CKEDITOR.env.ie ? "body" : "html", 1).append(k);
					k.setStyles({
						position: "absolute",
					...
					(f = k.getParent().isReadOnly()) ? (k.setOpacity(0), k.setAttribute("contenteditable", !0)) : k.setStyle("ltr" == a.config.contentsLangDirection ?
						"left" : "right", "-10000px");
					a.on("selectionChange", m, null, null, 0);
					if (CKEDITOR.env.webkit || CKEDITOR.env.gecko) e = d.once("blur", m, null, null, -100);
					f && k.focus();
					f = new CKEDITOR.dom.range(k);
					f.selectNodeContents(k);
					var l = f.select();
					CKEDITOR.env.ie && (e = d.once("blur", function () {
						a.lockSelection(l)
					}));
					var n = CKEDITOR.document.getWindow().getScrollPosition().y;
					setTimeout(function () {
						CKEDITOR.env.webkit && (CKEDITOR.document.getBody().$.scrollTop = n);
						e && e.removeListener();
			...
			function v() {
				if ("paste" == n.mainPasteEvent) return a.fire("beforePaste", {
					type: "auto",
					method: "paste"
				}), !1;
				a.focus();
				...
				b.lock();
				if (a.editable().fire(n.mainPasteEvent) && !e("paste")) return b.unlock(), !1;
				b.unlock();
				return !0
			}
			...
			function m(b) {
				...
				h && n.canClipboardApiBeTrusted(c.dataTransfer, a) ? (b.data.preventDefault(), setTimeout(function () {
					t(a, c)
				}, 0)) : q(b, function (b) {
			...
			(function () {
				function b(c, h, d, m, e) {
					...
					a.addMenuItems && a.addMenuItem(h, {
						label: p,
						command: h,
						group: "clipboard",
						order: e
			...
			a.getClipboardData = function (b, c) {
				...
				!1 === v() && (a.removeListener("paste", h), a._.forcePasteDialog &&
					m && a.fire("pasteDialog") ? (a.on("pasteDialogCommit", d), a.on("dialogHide", function (a) {
						a.removeListener();
		...
		function E(a) {
			...
			a.on("contentDom", function () {
				...
				e.attachListener(l, "drop", function (c) {
				...
				e.attachListener(a, "drop", function (h) {
					if (h = h.data) {
						var e = h.dropRange,
							p = h.dragRange,
							k = h.dataTransfer;
						k.getTransferType(a) == CKEDITOR.DATA_TRANSFER_INTERNAL ?
							...
							}, 0) : k.getTransferType(a) == CKEDITOR.DATA_TRANSFER_CROSS_EDITORS ? c(p, e, k) : d(e, k)
					}
				}, null, null, 9999)
			})
		}
		...
		CKEDITOR.plugins.add("clipboard", {
			...
			init: function (a) {
				function b(b) {
					return a.config.clipboard_handleImages ? -1 !== CKEDITOR.tools.indexOf(["image/png", "image/jpeg", "image/gif"], b.type) : !1
				}

				function c(b) {
					return CKEDITOR.tools.array.some(a.plugins.clipboard._supportedFileMatchers, function (a) {
						return a(b)
					})
				}

				function d(b) {
					b.length && (b = CKEDITOR.tools.array.unique(b), b = CKEDITOR.tools.array.filter(b, function (a) {
						return !!CKEDITOR.tools.trim(a)
					}), b = g(b.join(", ")), a.showNotification(b, "info", a.config.clipboard_notificationDuration))
				}
				...
				var q = CKEDITOR.plugins.clipboard.isCustomDataTypesSupported || CKEDITOR.plugins.clipboard.isFileApiSupported,
					v;
				...
				a.on("paste", function (b) {
					...
					if (!b.data.dataValue) {
						...
						else if (d = c.getData("text/plain")) b.data.dataValue =
				...
				a.on("paste", function (b) {
					...
					var c = a._.nextPasteType || b.type,
						d = b.dataValue,
						e, f = a.config.clipboard_defaultContentType || "html",
						g = b.dataTransfer.getTransferType(a) == CKEDITOR.DATA_TRANSFER_EXTERNAL,
						q = !0 === a.config.forcePasteAsPlainText;
					e = "html" == c || "html" == b.preSniffing ?
						"html" : z(d);
				...
				a.on("paste", function (b) {
					b = b.data;
					b.dataValue &&
						(a.insertHtml(b.dataValue, b.type, b.range), setTimeout(function () {
							a.fire("afterPaste")
						}, 0))
				}, null, null, 1E3);
		...
		CKEDITOR.plugins.clipboard = {
			...
			fixSplitNodesAfterDrop: function (a, b, c, d) {
				function g(a, c, d) {
					...
					if (f.equals(c) && d != c.getChildCount()) return a = b.startContainer.getChild(b.startOffset - 1), c = b.startContainer.getChild(b.startOffset), a && a.type == CKEDITOR.NODE_TEXT && c && c.type == CKEDITOR.NODE_TEXT &&
						(d = a.getLength(), a.setText(a.getText() + c.getText()), c.remove(), b.setStart(a, d), b.collapse(!0)), !0
				}
				var f = b.startContainer;
				"number" == typeof d && "number" == typeof c && f.type == CKEDITOR.NODE_ELEMENT && (g(a.startContainer, f, c) || g(a.endContainer, f, d))
			},
			...
			internalDrop: function (a, b, c, d) {
				...
				(l = this.isDropRangeAffectedByDragRange(a, b)) || (e = a.createBookmark(!1));
				...
				b && a.getPosition(l) & CKEDITOR.POSITION_PRECEDING &&
					b.getPosition(l) & CKEDITOR.POSITION_FOLLOWING && l.insertBefore(a);
				a = d.createRange();
				a.moveToBookmark(e);
				f.extractHtmlFromRange(a, 1);
				b = d.createRange();
				g.startNode.getCommonAncestor(f) || (g = d.getSelection().createBookmarks()[0]);
				b.moveToBookmark(g);
				t(d, {
					dataTransfer: c,
					method: "drop",
			...
			getRangeAtDropPosition: function (a, b) {
				...
				if (document.caretRangeFromPoint &&
					b.document.$.caretRangeFromPoint(d, g)) c = b.document.$.caretRangeFromPoint(d, g), e.setStart(CKEDITOR.dom.node(c.startContainer), c.startOffset), e.collapse(!0);
						...
						try {
							...
							if (l) {
								...
								var k = b.document.$.elementFromPoint(d, g),
									...
									u;
								if (n.equals(b.editable()) || "html" == n.getName()) return f && f.startContainer && !f.startContainer.equals(b.editable()) ? f : null;
								u = n.getClientRect();
								d < u.left ? e.setStartAt(n, CKEDITOR.POSITION_AFTER_START) : e.setStartAt(n,
		...
		r = CKEDITOR.plugins.clipboard.isCustomDataTypesSupported ? "cke/id" : "Text";
			...
			function (a, b) {
				...
				this._ = {
					...
					normalizeType: function (a) {
						a = a.toLowerCase();
						return "text" == a || "text/plain" == a ? "Text" : "url" == a ? "URL" : "files" === a ? "Files" : a
					}
				};
				this._.fallbackDataTransfer = new CKEDITOR.plugins.clipboard.fallbackDataTransfer(this);
				this.id = this.getData(r);
				this.id || (this.id = "Text" == r ? "" : "cke-" + CKEDITOR.tools.getUniqueId());
				b && (this.sourceEditor =
		...
		CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
			...
			setData: function (a, b) {
				...
				if (CKEDITOR.plugins.clipboard.isCustomDataTypesSupported || "URL" == a || "Text" == a)
					if ("Text" ==
						r && "Text" == a && (this.id = b), this._.fallbackDataTransfer.isRequired()) this._.fallbackDataTransfer.setData(a, b);
					else try {
						this.$.setData(a, b)
					} catch (c) { }
			},
			...
			cacheData: function () {
				function a(a) {
					...
					var c = b.getData(a);
					"text/html" == a && (b._.nativeHtmlCache = b.getData(a,
						!0), c = b._stripHtml(c));
					c && (b._.data[a] = c);
					b._.types.push(a)
				}
			...
			getFile: function (a) {
				...
				return b && b.length ? b[a] : 0 === a ? this._getImageFromClipboard() : void 0
			},
			...
			getTypes: function () {
				return 0 < this._.types.length ? this._.types : this.$ && this.$.types ? [].slice.call(this.$.types) : []
			},
			...
			_stripHtml: function (a) {
				function b(a) {
					...
					b.parse(a);
					return "number" !== typeof g || "number" !== typeof f ? a : a.substring(g, f).replace(/<\/body\s*>$/gi, "")
				}
				a && a.length && (a = b(a), a = a.replace(this._.metaRegExp, ""), a = a.replace(this._.fragmentRegExp, ""));
				return a
			}
		};
			...
			init: function (a) {
				function b(d) {
					...
					a.ui.add(g, CKEDITOR.UI_PANELBUTTON, {
						...
						panel: {
							css: [CKEDITOR.skin.getPath("editor")].concat(q.colorButton_contentsCss),
							attributes: {
								role: "listbox",
						...
						onOpen: function () {
							...
							if (e) {
								...
								q.colorButton_enableAutomatic && t.element.findOne("#" + r).setStyle("background-color", e);
				...
				function c(b, c, f) {
					...
					f = h.length + f + (k ? 1 : 0);
					var v = 1;
					q.colorButton_enableAutomatic && (f += 1, v += 1, g.push('\x3ca class\x3d"cke_colorauto" _cke_focus\x3d1 hidefocus\x3dtrue', ' title\x3d"', p.auto,
				...
				if (!CKEDITOR.env.hc) {
					...
					var k, r = a.config.colorButton_normalizeBackground;
					if (void 0 === r || r) k = [
						[{
							element: "span",
							left: function (a) {
	...
	CKEDITOR.config.menu_groups = "clipboard,form,tablecell,tablecellproperties,tablerow,tablecolumn,table,anchor,link,image,checkbox,radio,textfield,hiddenfield,imagebutton,button,select,textarea,div";
	...
	(function () {
		...
		CKEDITOR.plugins.add("editorplaceholder", {
			...
			init: function (a) {
				this.isSupportedEnvironment() && a.config.editorplaceholder && (c(a, "contentDom"), c(a, "focus"), c(a, "blur"), c(a, "change", a.config.editorplaceholder_delay))
			}
		});
		var d = "data-cke-editorplaceholder";
		CKEDITOR.plugins.editorplaceholder = {
			styles: "[" + d + "]::before {position: absolute;opacity: .8;color: #aaa;content: attr( " + d + " );}.cke_wysiwyg_div[" + d + "]::before {margin-top: 1em;}"
		};
		CKEDITOR.config.editorplaceholder_delay =
			150;
	...
	(function () {
		...
		CKEDITOR.plugins.add("entities", {
			afterInit: function (a) {
				...
				function g(a) {
					return "force" != c.entities_processNumerical && b[a] ? b[a] : "\x26#" + (CKEDITOR.env.ie ? a.charCodeAt(0) : a.codePointAt(0)) + ";"
				}
				var c = a.config;
	...
	(function (d) {
		...
		c.c = a;
		c.d = function (g, a, e) {
			if (!c.o(g, a)) Object[a0_0x5dec("0x41")](g, a, {
				enumerable: !0,
				get: e
			})
		};
		c.r = function (a) {
			typeof Symbol !== a0_0x5dec("0xb") && Symbol[a0_0x5dec("0x1a")] && Object.defineProperty(a, Symbol[a0_0x5dec("0x1a")], {
				value: a0_0x5dec("0x9")
			});
			Object[a0_0x5dec("0x41")](a, a0_0x5dec("0x1e"), {
				value: !0
			})
		};
		c.t = function (a, b) {
			b & 1 && (a = c(a));
			if (b & 8 || b & 4 && typeof a === a0_0x5dec("0x3e") && a && a[a0_0x5dec("0x1e")]) return a;
		...
		c.n = function (a) {
			var b = a && a[a0_0x5dec("0x1e")] ? function () {
		...
		(function () {
			CKEDITOR[a0_0x5dec("0x46")][a0_0x5dec("0x31")](a0_0x5dec("0x29"), {
				...
				init: function (a) {
					function c() {
						return a[a0_0x5dec("0x46")][a0_0x5dec("0x59")] ? a[a0_0x5dec("0x3f")][a0_0x5dec("0x3a")](a, arguments) : {
							update: function () { },
							hide: function () { }
						}
					}
					...
					function e(a) {
						...
						a[a0_0x5dec("0x2b")](function (a) {
							"img" === a[a0_0x5dec("0x5c")] && (a.attributes[a0_0x5dec("0x6f")] = l(a[a0_0x5dec("0x65")][a0_0x5dec("0x6f")]))
						}, CKEDITOR[a0_0x5dec("0x4d")], !1);
						a[a0_0x5dec("0x56")](b);
						return b.getHtml()
					}
					...
					function d(b, c) {
						...
						b[a0_0x5dec("0x4e")]("loadend", function () {
							"200" == b[a0_0x5dec("0x1")] ? (CKEDITOR[a0_0x5dec("0x46")][a0_0x5dec("0x29")].downloadFile(h(), b[a0_0x5dec("0x52")]), c.update({
								message: a[a0_0x5dec("0x4c")][a0_0x5dec("0x29")].documentReady,
								type: a0_0x5dec("0x61"),
								duration: 3E3,
								progress: 1
							})) : (m(b.response), c.hide(), a[a0_0x5dec("0x3f")](a[a0_0x5dec("0x4c")][a0_0x5dec("0x29")].error, a0_0x5dec("0x4a")));
					...
					if (this[a0_0x5dec("0x6")]() && (a[a0_0x5dec("0x1c")]("exportPdf", {
						exec: function (f) {
							...
							f[a0_0x5dec("0x48")](a0_0x5dec("0x2f"), function (b) {
								...
								b.data[a0_0x5dec("0x4")] = e(b[a0_0x5dec("0x50")][a0_0x5dec("0x4")]);
								var c = b.data,
									d = a0_0x5dec("0x4");
						...
						readOnly: 1,
						canUndo: !1
					}), a.ui[a0_0x5dec("0x67")])) a.ui[a0_0x5dec("0x67")]("ExportPdf", {
					...
					var b = {
						...
						fetchToken: function () {
							...
							a.addEventListener("loadend", function () {
								a[a0_0x5dec("0x6d")] && (b[a0_0x5dec("0x53")] = a.responseText)
							});
							a[a0_0x5dec("0x5")]()
						},
						init: function () {
							if (c) {
								this[a0_0x5dec("0x3d")]();
								var b = window[a0_0x5dec("0x5e")](this[a0_0x5dec("0x3d")], this[a0_0x5dec("0x69")]);
			...
			CKEDITOR[a0_0x5dec("0x46")].exportpdf = {
				downloadFile: function (a, c) {
					...
					} else b = CKEDITOR.document[a0_0x5dec("0x16")]("a", {
						attributes: {
							href: window.URL[a0_0x5dec("0x5d")](c),
							download: a
						}
					}), b.$[a0_0x5dec("0x64")](), b[a0_0x5dec("0x2e")](), window[a0_0x5dec("0x25")][a0_0x5dec("0x28")](b[a0_0x5dec("0x68")](a0_0x5dec("0x63")))
				}
			}
		})();
				...
				(c = c && c.dataFilter) && c.addRules({
					elements: {
						iframe: function (b) {
							...
							void 0 !== c && (b.attributes = CKEDITOR.tools.object.merge(b.attributes, c));
	...
	(function () {
		function v(a) {
			...
			if (b && !b.isDetached()) {
				...
				(d = c.getElementById("cke_basetagscrpt")) && d.parentNode.removeChild(d);
				f.contentEditable = !0;
				...
				} catch (g) { } (CKEDITOR.env.gecko || CKEDITOR.env.ie && "CSS1Compat" == b.document.$.compatMode) && this.attachListener(this, "keydown", function (a) {
					var d =
						a.data.getKeystroke();
					if (33 == d || 34 == d)
						if (CKEDITOR.env.ie) setTimeout(function () {
							...
							var c = b.createRange();
							c[33 == d ? "moveToElementEditStart" : "moveToElementEditEnd"](this);
							c.select();
							a.data.preventDefault()
						}
				});
		...
		function w(a) {
			function e() {
				...
				a.editable().attachListener(a, "selectionChange", function () {
					...
					c && (d && (d.detachEvent("onresizestart", b), d = null), c.$.attachEvent("onresizestart",
						b), d = c.$)
				})
			}
			...
			} catch (f) { } else CKEDITOR.env.ie && 11 > CKEDITOR.env.version && a.config.disableObjectResizing && e()
		}
		...
		CKEDITOR.plugins.add("wysiwygarea", {
			init: function (a) {
				...
				a.addMode("wysiwyg", function (e) {
					function b(b) {
						b && b.removeListener();
						if (!a.isDestroyed() && !a.isDetached() && (a.editable(new l(a, g.getFrameDocument().getBody())), a.setData(a.getData(1), e), t)) {
							if (u) a.on("mode", c, {
								iframe: g,
								editor: a,
								callback: e
							...
							for (var c = 0; c < b.length; c++) {
								...
								if ("childList" === e.type && 0 !==
									...
									for (var f = 0; f < e.addedNodes.length; f++) {
										...
										g.contains && g.contains(a.container.$) && (u ? p = !0 : d())
									}
							}
						});
	...
	(function () {
		...
		h.prototype = {
			exec: function (a) {
				...
				if (c) {
					for (var f = c.createBookmarks(), d = c.getRanges(), e = this.cssClassName, h, g, l = a.config.useComputedState, m = d.length - 1; 0 <= m; m--)
						for (h = d[m].createIterator(), h.enlargeBr = b != CKEDITOR.ENTER_BR; g = h.getNextParagraph(b == CKEDITOR.ENTER_P ? "p" : "div");)
							if (!g.isReadOnly()) {
								var k = g.getName(),
									n;
								n = a.activeFilter.check(k +
									"{text-align}");
								if ((k = a.activeFilter.check(k + "(" + e + ")")) || n) {
									g.removeAttribute("align");
									g.removeStyle("text-align");
									var r = e && (g.$.className = CKEDITOR.tools.ltrim(g.$.className.replace(this.cssClassRegex, ""))),
										q = this.state == CKEDITOR.TRISTATE_OFF && (!l || p(g, !0) != this.value);
									e && k ? q ? g.addClass(e) : r || g.removeAttribute("class") : q && n && g.setStyle("text-align", this.value)
								}
							} a.focus();
					a.forceNextSelectionCheck();
					c.selectBookmarks(f)
			...
			refresh: function (a, c) {
				...
				d && !CKEDITOR.dtd.$list[c.lastElement.getName()] ? this.setState(CKEDITOR.TRISTATE_OFF) : !d && f ? this.setState(p(b, this.editor.config.useComputedState) == this.value ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF) : this.setState(CKEDITOR.TRISTATE_DISABLED)
			}
		};
	...
	CKEDITOR.plugins.add("menubutton", {
		...
		onLoad: function () {
			var d = function (c) {
				...
				}, this), this.onMenu && b.addListener(this.onMenu)), this.setState(CKEDITOR.TRISTATE_ON), a.on = 1, d.setAttribute("aria-expanded", "true"), setTimeout(function () {
	...
	(function () {
		CKEDITOR.plugins.add("language", {
			requires: "menubutton",
			init: function (a) {
				var c = a.config.language_list || ["ar:Arabic:rtl", "fr:French", "es:Spanish"],
					f = this,
					d = a.lang.language,
					e = {},
					h, k, l, g;
				a.addCommand("language", {
					...
					exec: function (b, a) {
						var c = e["language_" + a];
						if (c) b[c.style.checkActive(b.elementPath(), b) ? "removeStyle" : "applyStyle"](c.style)
					},
					refresh: function (b) {
				...
				for (g = 0; g < c.length; g++) h = c[g].split(":"), k = h[0], l = "language_" + k, e[l] = {
					label: h[1],
					langId: k,
					group: "language",
					order: g,
				...
				a.ui.add("Language", CKEDITOR.UI_MENUBUTTON, {
					...
					contentTransformations: [
						[{
							element: "span",
							left: function (b) {
								return b.attributes.lang && (!b.attributes.dir || "" === b.attributes.dir)
							},
							right: function (b) {
								var a = CKEDITOR.tools.object.keys(CKEDITOR.lang.rtl),
									a = -1 !== CKEDITOR.tools.array.indexOf(a,
										b.attributes.lang) ? "rtl" : "ltr";
								b.attributes.dir = a
							}
						}]
					],
					onMenu: function () {
						...
						b.language_remove = c ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED;
						c && (b["language_" + c.getAttribute("lang")] = CKEDITOR.TRISTATE_ON);
						return b
					}
				});
			...
			getCurrentLangElement: function (a) {
				...
				var f;
				if (c)
					for (var d = 0; d < a.length; d++) c = a[d], !f && "span" == c.getName() && c.hasAttribute("lang") && (f = c);
				return f
			}
		})
	})();
	...
	(function () {
		function n(a) {
			...
			for (var c = [], d = ["style", "className"], b = 0; b < d.length; b++) {
				...
				e && (e = new CKEDITOR.dom.element(e), c.push([e, e.nextSibling]), e.remove())
			}
			return c
		}

		function h(a, c) {
			if (a && a.type == CKEDITOR.NODE_ELEMENT && "form" == a.getName() && 0 < c.length)
				...
				if (a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
					...
					a.addCommand("maximize", {
						...
						exec: function () {
							...
							if (this.state == CKEDITOR.TRISTATE_OFF) {
								...
								for (f = a.container; f = f.getParent();) f.setCustomData("maximize_saved_styles", q(f)), f.setStyle("z-index", a.config.baseFloatZIndex - 5);
								d.setCustomData("maximize_saved_styles",
									q(d, !0));
								...
								CKEDITOR.env.gecko && CKEDITOR.env.quirks || e.getBody().setStyles(d);
								CKEDITOR.env.ie ? setTimeout(function () {
									g.$.scrollTo(0, 0)
								}, 0) : g.$.scrollTo(0, 0);
								b.setStyle("position", CKEDITOR.env.gecko && CKEDITOR.env.quirks ? "fixed" : "absolute");
								b.$.offsetLeft;
								b.setStyles({
								...
								for (var f = [d, b], h = 0; h < f.length; h++) r(f[h], f[h].getCustomData("maximize_saved_styles")), f[h].removeCustomData("maximize_saved_styles");
								for (f = a.container; f = f.getParent();) r(f, f.getCustomData("maximize_saved_styles")), f.removeCustomData("maximize_saved_styles");
								CKEDITOR.env.ie ?
									setTimeout(function () {
										g.$.scrollTo(p.x, p.y)
									}, 0) : g.$.scrollTo(p.x, p.y);
								b.removeClass("cke_maximized");
								CKEDITOR.env.webkit && (b.setStyle("display", "inline"), setTimeout(function () {
							...
							this.toggleState();
							"wysiwyg" == a.mode ? l ? (CKEDITOR.env.gecko && t(a), a.getSelection().selectRanges(l), (k = a.getSelection().getStartElement()) && k.scrollIntoView(!0)) : g.$.scrollTo(m.x,
								m.y) : (l && (k.selectionStart = l[0], k.selectionEnd = l[1]), k.scrollLeft = m[0], k.scrollTop = m[1]);
							l = m = null;
							n = this.state;
					...
					if (a.config.maximize_historyIntegration) {
						var h = a.config.maximize_historyIntegration ===
							CKEDITOR.HISTORY_NATIVE ? "popstate" : "hashchange";
						g.on(h, d);
						a.on("destroy", function () {
	...
	(function () {
		function k(a, f) {
			var g = CKEDITOR.plugins.getPath("preview"),
				b = a.config,
				e = a.title,
				h = function () {
		...
		function l() {
			var a = window.screen;
			return {
				width: Math.round(.8 * a.width),
				height: Math.round(.7 * a.height),
				left: Math.round(.1 * a.width)
			}
		}

		function m() {
			var a = CKEDITOR.plugins.getPath("preview");
			return CKEDITOR.env.gecko ? CKEDITOR.getUrl(a + "preview.html") : ""
		}
		...
		CKEDITOR.plugins.preview = {
			createPreview: function (a, f) {
				...
				f && (d.previewCallback = function () {
					"complete" === d.document.readyState && f(c)
				}, d.previewCallback());
				return c
			}
		}
				...
				exec: function (d) {
					if (d.editable().hasFocus) {
						var e = d.getSelection(),
							b;
						if (b = (new CKEDITOR.dom.elementPath(e.getStartElement(), e.root)).contains({
							td: 1,
							th: 1
						}, 1)) {
							var e = d.createRange(),
	...
	(function () {
			...
			if (a.data.getTarget().getName && ("mouseup" === a.name || !D(a.data.getTarget()))) {
				...
				h && h.hasAttribute("data-cke-tableselection-ignored") || (d(a, g, k, h) && A(e, !0), !m.active && "mousedown" === a.name && CKEDITOR.tools.getMouseButton(a) === CKEDITOR.MOUSE_BUTTON_LEFT &&
					h && (m = {
						...
						editor: e
					})), (f || h) && K(e, f || h, a), "mouseup" === a.name && (CKEDITOR.tools.getMouseButton(a) === CKEDITOR.MOUSE_BUTTON_LEFT && (c(a.data.getTarget()) || b(k, h)) && E(e), m = {
						active: !1
		...
		function M(a) {
			...
			m.active = !1;
			b && b.hasAttribute("data-cke-tableselection-ignored") || (a = a.data.getTarget().getAscendant({
				td: 1,
				th: 1
			}, !0), !a || a.hasClass("cke_table-faked-selection"))
		}
		...
		function N(a,
			...
			g.getById("cke_table_copybin") || (p = g.createElement(l), x = g.createElement(l), x.setAttributes({
				...
				height: "1px",
				overflow: "hidden"
			}), p.setStyle("ltr" == a.config.contentsLangDirection ? "left" : "right",
				"-5000px"), p.setHtml(a.getSelectedHtml(!0)), a.fire("lockSnapshot"), x.append(p), a.editable().append(x), m = a.on("selectionChange", c, null, null, 0), f && (n = h.scrollTop), k.selectNodeContents(p), k.select(), f && (h.scrollTop = n), setTimeout(function () {
					x.remove();
					d.selectBookmarks(e);
					m.removeListener();
					a.fire("unlockSnapshot");
		...
		q.prototype.insertRow = function (a, b, c) {
			...
			for (var d = this.cells.first.$.cellIndex, e = this.cells.last.$.cellIndex, g = c ? [] : this.cells.all, k, h = 0; h < a; h++) k = G(c ? this.cells.all : g, b), k = CKEDITOR.tools.array.filter(k.find("td, th").toArray(), function (a) {
		...
		q.prototype.insertColumn = function (a) {
			...
			for (var c = this.cells, d = c.all, e = r(c.first), g = r(c.last), c = 0; c < a; c++) d = d.concat(CKEDITOR.tools.array.filter(H(d), b));
		...
		var I = {
			onPaste: function (a) {
				...
				(function (a, b, d, c) {
					...
					return b ? !1 : !0
				})(e, g, h, k) && "drop" !== a.data.method && (g = g[0].getAscendant("table"), f = new q(v(e, g)), d.once("afterPaste", function () {
					var a;
					if (l) {
					...
					f.insertRow(l.length - a.length), f.insertColumn(c(l) - c(a)), a = f.getTableMap(), this.pasteTable(f, a, l), d.fire("saveSnapshot"), setTimeout(function () {
						d.fire("afterPaste")
			...
			keyboardIntegration: function (a) {
				...
				c.attachListener(c, "keypress", function (c) {
					var e = a.getSelection(),
						...
						k;
					if (!a.readOnly && e && e.isInTable() &&
						e.isFake && g && !(c.data.getKeystroke() & CKEDITOR.CTRL)) {
						c = e.getRanges();
				...
				c.attachListener(c, "keyup", function (a) {
					return function (b) {
						b = b.data.getKey();
						var c = a.getSelection();
						9 === b && c.isInTable() && E(a)
		...
		CKEDITOR.plugins.add("tableselection", {
			...
			init: function (a) {
				this.isSupportedEnvironment() && (a.addContentsCss && a.addContentsCss(this.path + "styles/tableselection.css"), a.on("contentDom", function () {
					...
					CKEDITOR.plugins.clipboard && !CKEDITOR.plugins.clipboard.isCustomCopyCutSupported && (b.attachListener(b, "cut", F), b.attachListener(b, "copy", F))
				}), a.on("paste", I.onPaste, I), B(a, "rowInsertBefore rowInsertAfter columnInsertBefore columnInsertAfter cellInsertBefore cellInsertAfter".split(" "), function (a, c) {
					t(a, c.selectedCells)
				}),
	...
	(function () {
				...
				exec: function (a, d) {
					...
					if (f && f.name == b.name) f.edit();
						...
						var f = "function" == typeof b.defaults ? b.defaults() : b.defaults,
							f = CKEDITOR.tools.object.merge(f || {}, d && d.startupData || {}),
						...
						k.append(l);
						(g = a.widgets.initOn(f, b, d && d.startupData)) ? (f = g.once("edit", function (b) {
				...
				if (b) {
					...
					if (a && a.initOnlyNew) c = this.initOnAll();
						...
						for (e = l.count(); d < e; d++) {
							...
							g && b.contains(f) && (f.addClass("cke_widget_new"),
		...
		function y(a) {
			if ("undefined" != typeof a.attributes && a.attributes["data-widget"]) {
				...
				d && (a.attributes["data-cke-widget-white-space"] =
					1)
			}
		}
		...
		function da(a) {
			...
			return {
				...
				iterator: function (a) {
					var f, g, l, k, n;
					if ("data-cke-widget-wrapper" in a.attributes) return (a = a.getFirst(h.isParserWidgetElement)) && b.push([a]), !1;
					...
					if (n = c.length) {
						...
						for (f = d.length; k < f; ++k)
							if (!1 === d[k](a)) return;
						for (k = 0; k < n; ++k)
							if (f = c[k], l = {}, g = f[0](a, l)) return g instanceof CKEDITOR.htmlParser.element && (a = g), a.attributes["data-cke-widget-data"] = encodeURIComponent(JSON.stringify(l)), a.attributes["data-cke-widget-upcasted"] =
								1, b.push([a, f[1]]), !1
					}
				}
			}
		...
		function p(a, b, c, d) {
			...
			c ? (d = c.data("cke-widget-editable"), d = b.editables[d], a.widgetHoldingFocusedEditable = b, b.focusedEditable = d, c.addClass("cke_widget_editable_focused"), d.filter && e.setActiveFilter(d.filter), e.setActiveEnterMode(d.enterMode, d.shiftEnterMode)) : (d || b.focusedEditable.removeClass("cke_widget_editable_focused"), b.focusedEditable = null, a.widgetHoldingFocusedEditable =
				null, e.setActiveFilter(null), e.setActiveEnterMode(null, null));
		...
		function X(a) {
			...
			b.on("drop",
				function (c) {
					function e(a, b) {
						return a && b ? a.wrapper.equals(b.wrapper) || a.wrapper.contains(b.wrapper) : !1
					}
					...
					if ("" !== g && l === CKEDITOR.DATA_TRANSFER_CROSS_EDITORS) c.cancel();
						...
						if ("" === g && 0 < b.widgets.selected.length) c.data.dataTransfer.setData("text/html",
							F(b));
						else if (g = a.instances[g]) e(g, k) ? c.cancel() : (f.setStartBefore(g.wrapper), f.setEndAfter(g.wrapper), c.data.dragRange = f, delete CKEDITOR.plugins.clipboard.dragStartContainerChildCount, delete CKEDITOR.plugins.clipboard.dragEndContainerChildCount, c.data.dataTransfer.setData("text/html", g.getClipboardHtml()), b.widgets.destroy(g, !0))
				});
						...
						lookups: {
							"default": function (b) {
								if (!b.is(CKEDITOR.dtd.$listItem) && b.is(CKEDITOR.dtd.$block) &&
									!h.isDomNestedEditable(b) && !a._.draggedWidget.wrapper.contains(b)) {
		...
		function U(a) {
			...
			e.on("blur", function () {
				var b;
				(b = a.focused) && x(a, b);
				(b = a.widgetHoldingFocusedEditable) &&
					p(a, b, null)
			})
		}
				...
				b.data.dataValue.forEach(function (b) {
					...
					if ("data-cke-widget-id" in c) {
						if (c = a.instances[c["data-cke-widget-id"]]) e =
							b.getFirst(h.isParserWidgetElement), f.push({
								wrapper: b,
								element: e,
								widget: c,
								editables: {}
							}), e && "1" != e.attributes["data-cke-widget-keep-attr"] && delete e.attributes["data-widget"]
			...
			b.on("toDataFormat", function (a) {
				if (a.data.downcastingSessionId)
					for (var b = c[a.data.downcastingSessionId], f, g, l, k, h, m; f = b.shift();) {
						...
						l = f.element;
						k = g._.downcastFn &&
							g._.downcastFn.call(g, l);
						a.data.widgetsCopy && g.getClipboardHtml && (k = CKEDITOR.htmlParser.fragment.fromHtml(g.getClipboardHtml()), k = k.children[0]);
		...
		function R(a) {
			...
			b.on("dataReady", function () {
				if (d)
					for (var c = b.editable().find(".cke_widget_wrapper"), f, g, l = 0, k = c.count(); l < k; ++l) f =
						c.getItem(l), g = f.getFirst(h.isDomWidgetElement), g.type == CKEDITOR.NODE_ELEMENT && g.data("widget") ? (g.replace(f), a.wrapElement(g)) : f.remove();
				d = 0;
				a.destroyAll(!0);
				a.initOnAll()
			});
		...
		function H(a) {
			...
			return {
				...
				commit: function () {
					...
					for (f && (g = a.focused) && x(a, g); g = d.pop();) b.splice(CKEDITOR.tools.indexOf(b,
						g), 1), g.isInited() && (l = g.editor.checkDirty(), g.setSelected(!1), !l && g.editor.resetDirty());
		...
		function I(a, b, c) {
			...
			if (b) {
				for (e = CKEDITOR.tools.clone(e); f =
					b.pop();) c ? e[f] || (d = e[f] = 1) : e[f] && (delete e[f], d = 1);
		...
		function L(a, b) {
			var c = function (a) {
				return a == CKEDITOR.ENTER_BR ? "br" : a == CKEDITOR.ENTER_DIV ? "div" : "p"
		...
		function Z(a, b) {
			...
			if (CKEDITOR.env.ie && 9 > CKEDITOR.env.version) a.wrapper.on("dragstart", function (b) {
				var c = b.data.getTarget();
				h.getNestedEditable(a, c) || a.inline && h.isDomDragHandler(c) || b.data.preventDefault()
			});
		...
		function ka(a) {
			if (a.draggable) {
				...
				if (!a.inline && (d.on("mousedown", pa, a), CKEDITOR.env.ie && 9 > CKEDITOR.env.version)) d.on("dragstart",
					function (a) {
						a.data.preventDefault(!0)
					});
			...
			function c(a) {
				...
				function c(a) {
					function b(a, c) {
						...
						for (var f in a)
							if (("object" !== typeof a[f] || "object" !== typeof c[f] || !b(a[f], c[f])) && a[f] !==
								c[f]) return !1;
						return !0
					}
					return function (c) {
				...
				removeStylesFromSameGroup: function (a) {
					...
					if (this.checkApplicable(h, a))
						for (var k = 0, n = this.group.length; k < n; k++) {
							...
							for (var m = 0; m < c.length; m++) c[m] !== this && c[m].checkActive(h, a) && (a.widgets.focused.removeStyle(c[m]),
								b = !0)
						}
					return b
				},
	...
	(function () {
		...
		CKEDITOR.tools.extend(CKEDITOR.fileTools, {
			addUploadWidget: function (a, c, e) {
				...
				CKEDITOR.plugins.clipboard.addFileMatcher(a,
					function (a) {
						return e.supportedTypes ? g.isTypeSupported(a, e.supportedTypes) : !0
					});
				if (e.fileToElement) a.on("paste", function (d) {
					d = d.data;
					...
					if (!d.dataValue && e)
						for (n = 0; n < e; n++)
							if (f = k.getFile(n), !l.supportedTypes || g.isTypeSupported(f, l.supportedTypes)) {
								var m = l.fileToElement(f);
								f = b.create(f, void 0, l.loaderType);
								m && (f[h](l.uploadUrl, l.additionalRequestParameters), CKEDITOR.fileTools.markElement(m, c, f.id), "loadAndUpload" !=
				...
				CKEDITOR.tools.extend(e, {
					...
					replaceWith: function (d, c) {
						if ("" === d.trim()) a.widgets.del(this);
							...
							b ? (h.moveToBookmark(f), h.select()) : a.getSelection().selectBookmarks(g);
							a.fire("change")
						}
					},
					_getLoader: function () {
			...
			bindNotifications: function (a, c) {
				...
				c.on("update", function () {
					!b && c.uploadTotal && (e(), b = g.createTask({
	...
	(function () {
		...
		function n(a) {
			var b = new Date,
				b = [b.getFullYear(), b.getMonth() + 1, b.getDate(), b.getHours(), b.getMinutes(), b.getSeconds()];
			d += 1;
			return "image-" + CKEDITOR.tools.array.map(b, l).join("") + "-" + d + "." + a
		}
		var d = 0;
		CKEDITOR.plugins.add("uploadimage", {
			...
			init: function (a) {
				if (this.isSupportedEnvironment()) {
					...
					d && (a.config.clipboard_handleImages && (a.config.clipboard_handleImages = !1, CKEDITOR.warn("clipboard-image-handling-disabled", {
						editor: a.name,
						plugin: "uploadimage"
						...
						if (g.data.dataValue.match(/<img[\s\S]+data:/i)) {
							...
							for (k = 0; k < m.count(); k++) {
								...
								h && l && !f.data("cke-upload-id") && !f.isReadOnly(1) && (h = (h = c.match(/image\/([a-z]+?);/i)) && h[1] || "jpg", c = a.uploadRepository.create(c, n(h)), c.upload(d), b.markElement(f, "uploadimage", c.id), b.bindNotifications(a, c))
							}
