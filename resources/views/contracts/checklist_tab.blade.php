    ...
    <div class="col-12">
        <div class="card card-primary">
            <div class="card-header">
                <h4>Checklist Note</h4>
                <div class="card-header-action">
                    <input type="button" id="btn_checklist_add" value="Add Note" class="btn btn-primary" data-toggle="modal"
                        ...
                        <tbody>
                            ...
                            @foreach ($checklists as $index => $checklist)
                                <tr>
                                    ...
                                    <td><a href="#" data-toggle="modal" id="showChkEditModal"
