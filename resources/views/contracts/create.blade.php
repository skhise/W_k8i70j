                                ...
                                <form id="frmcreateclient" method="post" enctype="multipart/form-data"
                                            ...
                                            <div class="col-md-3 floating-label">
                                                ...
                                                @if ($errors->has('CNRT_Number'))
                                                    <span class="text-danger field-validation-valid"
                                                        data-valmsg-for="CNRT_Number"
                                                        data-valmsg-replace="true">{{ $errors->first('CNRT_Number') }}</span>
                                                @endif
                                            </div>
                                            <div class="col-md-3 floating-label">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 floating-label required">
                                                <select
                                                    ...
                                                    data-val="true"
                                                    data-val-required="The Customer Name field is required."
                                                    id="CNRT_Type" name="CNRT_Type" placeholder="" required="required"
                                                    type="text"
                                                    value="{{ $contract->CNRT_Type ?? old('CNRT_Type') }}">
                                                    <option value="">Select contract type</option>
                                                    @foreach ($contract_type as $contracttype)
                                                        <option value="{{ $contracttype->id }}"
                                                            {{ $contracttype->id == $contract->CNRT_Type
                                                                ? 'selected'
                                                                : (old('CNRT_Type') == $contracttype->id
                                                                    ? 'selected'
                                                                    : '') }}>
                                            ...
                                            <div class="col-md-3 floating-label required">
                                                <select
                                                    ...
                                                    @foreach ($site_type as $sitetype)
                                                        <option value="{{ $sitetype->id }}"
                                                            {{ $sitetype->id == $contract->CNRT_SiteType
                                                                ? 'selected'
                                                                : (old('CNRT_SiteType') == $sitetype->id
                                                                    ? 'selected'
                                                                    : '') }}>
                                                ...
                                                @if ($errors->has('CNRT_Type'))
                                                    <span class="text-danger field-validation-valid"
                                                        ...
                                                        data-valmsg-replace="true">{{ $errors->first('CNRT_SiteType') }}</span>
                                                @endif
                                            </div>
                                            <div class="col-md-3 floating-label">
                                                ...
                                                @else
                                                    <select
                                                        ...
                                                        @foreach ($clients as $client)
                                                            <option value="{{ $client->CST_ID }}"
                                                                {{ $client->CST_ID == $contract->CNRT_CustomerID
                                                                    ? 'selected'
                                                                    : (old('CNRT_CustomerID') == $client->CST_ID
                                                                        ? 'selected'
                                                                        : '') }}
                                                                data-client="{{ $client }}">
                                                    ...
                                                    @if ($errors->has('CNRT_Type'))
                                                        <span class="text-danger field-validation-valid"
                                                            ...
                                                            data-valmsg-replace="true">{{ $errors->first('CNRT_CustomerID') }}</span>
                                                    @endif
                                                @endif
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 floating-label">
                                                <input class="form-control text-box single-line"
                                                    id="CNRT_CustomerContactPerson" name="CNRT_CustomerContactPerson"
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <textarea class="form-control" id="CNRT_OfficeAddress" name="CNRT_OfficeAddress" placeholder="" rows="2">{{ $contract->CNRT_OfficeAddress ?? old('CNRT_OfficeAddress') }}</textarea>
                                                </textarea>
                                                <span class="text-danger field-validation-valid"
                                            ...
                                            <div class="col-md-3 floating-label">
                                                ...
                                                <select name="CNRT_Site" id="CNRT_Site"
                                                    class="form-control text-box single-line select2" palceholder="">
                                                    <option value="">Select site location</option>
                                                    @foreach ($sitelocation as $location)
                                                        <option value="{{ $location->id }}"
                                                            {{ $location->id == $contract->CNRT_Site ? 'selected' : (old('CNRT_Site') == $location->id ? 'selected' : '') }}>
                                                            {{ $location->SiteAreaName }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-md-3 floating-label required">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 floating-label">
                                                <input class="form-control text-box single-line disabled"
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <textarea class="form-control" id="CNRT_Note" name="CNRT_Note" placeholder="Note" rows="2">{{ $contract->CNRT_Note ?? old('CNRT_Note') }}</textarea>
                                                </textarea>
                                                <span class="text-danger field-validation-valid"
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <textarea class="form-control" id="CNRT_TNC" name="CNRT_TNC" placeholder="Term / Condition" rows="2">{{ $contract->CNRT_TNC ?? old('CNRT_TNC') }}</textarea>
                                                </textarea>
                                                <span class="text-danger field-validation-valid"
