        ...
        <ul class="sidebar-menu">
            ...
            @else
                ...
                <li class="dropdown {{ Request::is('contract-products') ? 'active' : '' }}">
                    <a href="{{ route('contracts.products') }}" class="nav-link"><i data-feather="package"></i><span>AMC Products</span></a>
                </li>
                ...
                <li class="dropdown {{ Request::is('product-assignments') || Request::is('product-assignments/*') ? 'active' : '' }}">
                    <a href="{{ route('product-assignments') }}" class="nav-link"><i data-feather="user-check"></i><span>Assign Spares</span></a>
                </li>
                <!-- <li class="dropdown {{ Request::is('product-returns') || Request::is('product-returns/*') ? 'active' : '' }}">
                    <a href="{{ route('product-returns') }}" class="nav-link"><i data-feather="user-check"></i><span>Return Spares</span></a>
                </li> -->
                <li class="dropdown {{ Request::is('utilized-product-report') ? 'active' : '' }}">
                    <a href="{{ route('utilized-product-report') }}" class="nav-link"><i data-feather="package"></i><span>Utilized Report</span></a>
                </li>
                <li class="dropdown {{ Request::is('spares-utilized-report') ? 'active' : '' }}">
