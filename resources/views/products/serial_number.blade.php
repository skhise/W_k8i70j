        ...
        <div class="card card-primary">
            <div class="card-header">
                ...
                <div class="card-header-action">
                    <input type="button" id="btn_service_add" value="Add" class="btn btn-primary" data-toggle="modal"
                        data-target=".bd-RefPSR-modal-lg" />
                </div>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            @foreach ($serialnumbers as $index => $serialnumber)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('product_srno.delete', $serialnumber['id']) }}"
