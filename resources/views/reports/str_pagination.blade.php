...
@else
    @foreach ($services as $service)
        <tr>
            ...
            <td>{{ $service->CST_Name }}</td>
            <td>{{ $service->created_at != null ? date('d-M-Y', strtotime($service->created_at)) : 'NA' }}</td>
            ...
            <td>{{ $service->resolved_datetime != null ? date('d-M-Y', strtotime($service->resolved_datetime)) : 'NA' }}
            </td>
