                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    ...
                                                    <input id="standby_date" value="{{date('Y-m-d')}}" type="date" name="standby_date" class="required form-control">
                                                </div>
                                                @if(empty ($service->id))
                                                <div class="col-lg-3">
                                                    <label>Customer Name<span class="error">*</span></label>
                                                    <select id="standby_customer" name="standby_customer" class="required form-control" onchange="getCustomerCall()">
                                                    </select>
                                                </div>
                                                <div class="col-lg-3">
                                                    <label>Call Ref.No.<span class="error">*</span>&nbsp;&nbsp;&nbsp;<a href="add_AddService.php">Add New</a></label>
                                                        <select class="required form-control " id="call_ref_no" name="call_ref_no" id="call_ref_no">
                                                        </select>
                                                </div>
                                                @endif
                                                <div class="col-lg-3">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                  <div class="col-lg-2">
                                                    ...
                                                    <select id="product_type" name="product_type" class="required form-control">
                                                        <option value="">Select Type</option>
                                                ...
                                                <div class="col-lg-2">
                                                    <label>Product</label>
                                                    <select id="standby_product" name="standby_product" class="required form-control">
                                                    <option value="">Select Product</option>
                                                    </select>
                                                    <span class="alert text-center square hide" id="error_bill_product">Select product</span>
                                                </div>
                        					    <div class="col-lg-2">
                                                    <label>Select Serial No.</label>
                                                    <select id="productSerialNo" name="productSerialNo" class="form-control">
                                                    </select>
                                                </div>
                                                <div class="col-lg-2">
                                                    <label>Amount</label>
                                                ...
                                                <div class="col-lg-1">
                                                    <label>&nbsp;</label><br>
                                                    <button type="submit" id="product_add" class="btn btn-sm btn-primary">Add</button>
                                                </div>
                                            </div>
                                        </div>
                                        </form>
                                        ...
                                        <table id="myTable" class="table table-striped">
                                            <thead>
                                                <tr class="mb-2">
                                                    ...
                                                    <td>
                                                    <div class="d-flex">
                                                        <div class="action-btn">Total DC Cost:<span id="dc_total_cost" style="font-weight:700">0</span></div>
                                                    </div>
                                                    </td>
                                                    <td>
                                                    <div class="d-flex">
                                                        <button id="btn_save_data" class="action-btn btn btn-primary">Save</button>
                                                        <button id="btn_clear_data" class="action-btn btn btn-danger">Reset</button>
                                                    </div>
                                                    </td>
                                                </tr>
                                                <tr>
